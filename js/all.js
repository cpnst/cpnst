            ...
            function() {
                ...
                var l, _, u, p, f, c, m = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
                    ...
                    Y = function() {
                        ...
                        return u = -1 !== z.indexOf("Safari") && -1 === z.indexOf("Chrome") && (-1 === e || Number(z.substr(e + 8, 1)) > 3), f = u && 6 > Number(z.substr(z.indexOf("Version/") + 8, 1)), p = -1 !== z.indexOf("Firefox"), /MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(z), c = parseFloat(RegExp.$1), i.innerHTML = "<a style='top:1px;opacity:.55;'>a</a>" 

                        // ,t = i.getElementsByTagName("a")[0], !!t && /^0.55/.test(t.style.opacity)
    ...
    t.prototype = {
        init: function() {
            var e = this,
                o = e._parent;
            return 
            e._muted = o._muted, e._loop = o._loop, e._volume = o._volume, e._rate = o._rate, e._seek = 0, e._paused = !0, e._ended = !0, e._sprite = "__default", e._id = ++n._counter, o._sounds.push(e), e.create(), e
        },
        create: function() {
          console.log('创建音频');
            var e = this,
            ...
            return 
            o._webAudio ? 
            (e._node = void 0 === n.ctx.createGain ? n.ctx.createGainNode() : n.ctx.createGain(), e._node.gain.setValueAtTime(t, n.ctx.currentTime), e._node.paused = !0, e._node.connect(n.masterGain)) : (e._node = new Audio, e._errorFn = e._errorListener.bind(e), e._node.addEventListener("error", e._errorFn, !1), e._loadFn = e._loadListener.bind(e), e._node.addEventListener(n._canPlayEvent, e._loadFn, !1), e._node.src = o._src, e._node.preload = "auto", e._node.volume = t * n.volume(), e._node.load()), e
...
function resetGameData() {
    isBonusLevel ? (bonusLevelNum = 24, oGameData = {
        ...
        //前5关添加过关时间
    }, 0 == levelNum && (oGameData.time += 300),levelNum < 5 && (oGameData.time += 300),levelNum < 3 && (oGameData.time += 200))
}
...
function initSplash() {
    ...
    }, resizeCanvas(), getLatestData(), 1 != audioType || muted || (playMusic(), hasFocus || music.pause()), registerGyro(), initStartScreen()
}
// update 重力感应
function registerGyro() {
  return; //暂时不使用
  wx && wx.onAccelerometerChange && wx.onAccelerometerChange(function(res) {
    if(res.y > 0.2) {
      leftSteer = 1, rightSteer = 0;
    }
    else if(res.y < -0.2) {
      leftSteer = 0, rightSteer = -1;
    }
    else {
      leftSteer = rightSteer = 0;
    }
  });
}
...
function initStartScreen() {    // initStartScreen
  /*wx.startAccelerometer({
    interval: 'normal'
  })*/

  console.log("initStartScreen")
  !window.bannerAd && window.showBannerAd(1)
  //window.adPlugin.showBanner()
    // window.bannerAd == null && window.showBannerAd();
    //edit

  //window.bannerAdPlugin.show();
  //window.bannerAdPlugin2.show();

    //window.showbanner();
  //window.adPlugin.run();

    window.share && window.share.updataeConfig()
    gameState = "start";
    try {
      if(!muted){
        console.log('play mainMusic')
        window.mainMusic.play();
      }
        window.famobi_analytics.trackScreen(famobi_analytics.SCREEN_HOME)
    } catch (a) {}
    userInput.removeHitArea("moreGames"), 1 == audioType && music.fade(music.volume(), .25, 500), levelScore = 0, levelNum = 0, background = new Elements.Background("Bg");console.log('ratio:',ratio, window.innerHeight)
    var t, e = {
            oImgData: assetLib.getData("uiElements"),
            aPos: assetLib.getRealPos("uiElements", oImageIds.careerPlayBth, 615, iphoneX ? 135 : 185, ratio),
            align: [0, 0],
            id: oImageIds.careerPlayBth,
            scale: ratio * 0.9
        },
        i = {
            oImgData: assetLib.getData("uiElements"),
            aPos: assetLib.getRealPos("uiElements", oImageIds.shareBtn, 942, iphoneX ? 300 : 350, ratio),
            align: [0, 0],
            id: oImageIds.shareBtn,
            noMove: !0,
            scale: ratio * 0.9
        },
        s = {
        ...
        o = {
            oImgData: assetLib.getData("uiElements"),
            aPos: assetLib.getRealPos("uiElements", oImageIds.upgradeBtn, 944, iphoneX ? 135 : 185, ratio),
            align: [0, 0],
            id: oImageIds.upgradeBtn,
            noMove: !0,
            scale: ratio * 0.9
        },
      moregame = {
        oImgData: assetLib.getData("sepecialgame"),
        aPos: [100, canvas.height / 3 - 30],
        align: [0, 0],
        id: window.gameConf.MoreGameid
      },
        // 增加分享得赛车/金币按钮
        m = saveDataHandler.getBikeCount() == 0 ?
        {
            oImgData: assetLib.getData("uiElements"),
          aPos: [100, -255],
          align: [0, 1],
          ...
          id: oImageIds.freeCarBtn,
          scale: 1e-4,
          noMove: !0
          } : (window.checkLeftTime(saveDataHandler.getBikeCount()) == !0 ? {
            oImgData: assetLib.getData("uiElements"),
            aPos: [100, -255],
            align: [0, 1],
            //aPos: [100, 60],
            //align: [0, 0],
            id: oImageIds.freeBoxDisabled,
            scale: 1e-4,
            noMove: !0
          } : {
            oImgData: assetLib.getData("uiElements"),
          ...
          //aPos: [100, 60],
          //align: [0, 0],
          id: oImageIds.freeBoxBtn,
          scale: 1e-4,
          noMove: !0
        }),
        // 增加分享得道具按钮
        n = window.checkLeftTime(saveDataHandler.getCoinLeftTime()) == !0 ? {
          oImgData: assetLib.getData("uiElements"),
          aPos: [100, -155],
          align: [0, 1],
          //aPos: [200, 60],
          //align: [0, 0],
          id: oImageIds.freeAccDisabled,
          scale: 1e-4,
          noMove: !0
        } : {
          oImgData: assetLib.getData("uiElements"),
    ...
    // debug
  //console.log(oImageIds["bike" + (curBike + 1)]);
    /*var y = {
      oImgData: assetLib.getData("bike"),
      aPos: assetLib.getRealPos("bike", ("bike" + (curBike + 1)), 215, 210, ratio),
      align: [0, 0],
      id: ("bike" + (curBike + 1)),
      noMove: !0,
      scale: ratio
    ...
    t = {
      oImgData: assetLib.getData("uiElements"),
      aPos: assetLib.getRealPos("uiElements", oImageIds.shopBtn, 613, iphoneX ? 300 : 350, ratio),
      align: [0, 0],
      id: oImageIds.shopBtn,
      noMove: !0,
      scale: ratio * 0.9
    }
      , userInput.addHitArea("SpecialList", butEventHandler, null, "image", moregame)
    ...
    , userInput.addHitArea("friendShare", butEventHandler, null, "image", i)
    //, userInput.addHitArea("shareGetCarOrCoin", butEventHandler, null, "image", m)
    //, userInput.addHitArea("shareGetAcce", butEventHandler, null, "image", n)
    , userInput.addHitArea("credits", butEventHandler, null, "image", s);
  var r = new Array(/*y, */e, s, o, m, n, t, i, moregame);
    /*setTimeout(function() {
      if(window.gameConf.enableMultiple != 0) {
        m.scale = n.scale = 1, userInput.addHitArea("shareGetCarOrCoin", butEventHandler, null, "image", m)
        , userInput.addHitArea("shareGetAcce", butEventHandler, null, "image", n)
      }
    }, 0);*/
  if (window.gameConf.enableMultiple != 0) {
...
function initMapScreen() {
    console.log('3028 ==> initMapScreen');
    //window.adPlugin.hideBanner();	
    //console.log("3129==>", window.bannerAd)
    // (window.bannerAd == null) && (window.showBannerAd())
    (window.bannerAd == null) && window.showBannerAd(1)
    gameState = "map";
    try {
    ...
    t = saveDataHandler.getLatestBike() < 8 && totalCoins >= aBikeData[saveDataHandler.getLatestBike() + 1].cost ? {
        ...
        aRect: [canvas.width - 70 - 80 - 50, canvas.height - 40 - 41 - 100, canvas.width - 70 + 80 - 50, canvas.height + 40 - 41 - 100]
    }, !0)
    ...
    addMuteBut(s), panel = new Elements.Panel(gameState, s)
...
function initUpgradeScreen() {
  console.log("initUpgradeScreen")
  window.showBannerAd(2)
 // window.adPlugin.showBanner();
    // window.bannerAd == null && window.showBannerAd();
    window.famobi_analytics.trackScreen("SCREEN_OTHER", "SCREEN_UPGRADE"), gameState = "upgrade", background = new Elements.Background("Bg");
    var a, t = {
        oImgData: assetLib.getData("uiButs"),
        aPos: [50, -40],
        align: [0, 1],
    ...
    a = saveDataHandler.getLatestBike() < 8 && totalCoins >= aBikeData[saveDataHandler.getLatestBike() + 1].cost ? {
      ...
      aRect: [canvas.width / 2 - 275 - 45, canvas.height / 2 + 0 - 30 - offsetY, canvas.width / 2 - 275 + 45, canvas.height / 2 + 0 + 30 - offsetY]
    ...
    for (var e = new Array({
        ...
        aRect: [e[i].x - 60, e[i].y - 25 - offsetY, e[i].x + 60, e[i].y + 25 - offsetY]
    }, !1);
...
function initBikeShopScreen(a) {
    bikeDiscountList = window.share.getData("bikeDiscountList")
    window.showBannerAd(3)
 // window.adPlugin.showBanner();
    console.log('==bikeDiscountList==', bikeDiscountList);
    //console.log("initBikeShopScreen")
    // window.bannerAd == null && window.showBannerAd();
    "undefined" == typeof a && (a = !1), gameState = "bikeShop";
    try {
        window.famobi_analytics.trackScreen(famobi_analytics.SCREEN_SHOP)
    } catch (t) {}
    background = new Elements.Background("Bg");
    var offsetY = 40;
    var e = {
            oImgData: assetLib.getData("uiButs"),
            aPos: [50, -40],
    ...
    userInput.addHitArea("buyBike", butEventHandler, null, "rect", {
      aRect: [canvas.width / 2 - 165 - 80, canvas.height / 2 - 35 + 132 - 30 - offsetY, canvas.width / 2 + 0 - 20, canvas.height / 2 - 35 + 142 + 30 - offsetY]
    }, !1),
    userInput.addHitArea("onDiscount", butEventHandler, null, "rect", {
      aRect: [canvas.width / 2 + 20, canvas.height / 2 - 35 + 132 - 30 - offsetY, canvas.width / 2 + 250, canvas.height / 2 - 35 + 142 + 30 - offsetY]
    }, !1), 
    userInput.addHitArea("backFromBikeShop", butEventHandler, null, "image", e), userInput.addHitArea("shopFromBikeShop", butEventHandler, null, "image", i);
    var s = new Array(e, i);
...
function initGame() {
  /*0 == controlMethod && wx.startAccelerometer && wx.startAccelerometer({
    interval: 'game'
  });*/

  window.gameMusic.play();
  console.log("initGame")
  oGameData.multiple = 1, state = '', getDoubleCoins = !1;
    window.share && window.share.updataeConfig()
    window.famobi_analytics.trackScreen("SCREEN_LEVEL"),
     gameState = "game", playSound("raceStart"),
    ...
    userInput.addHitArea("superSpeed", butEventHandler, null, "image", aa);
    var t = new Array(a,aa);
    addMuteBut(t), 
    panel = new Elements.Panel(gameState, t),
     ...
     road = new Elements.Road,
      ...
      vehicleRelease = 0, 
      isAccelerating = !1, 
      isSuperAccelerating = !1,//加速开关
      superAccelerating = 0,//加速时间
      aVehicles = new Array, 
    ...
    hud = new Elements.Hud,setControl(), 
...
function initPause() {
    ...
    panel = new Elements.Panel(gameState, o), panel.startTween1(), previousTime = (new Date).getTime(), background = new Elements.Background("Bg"), updatePauseEvent()
}

function initConfirm() {
  window.showBannerAd(5)
  console.log("initConfirm")
  gameState = "confirm";
  try {
    window.famobi_analytics.trackScreen(famobi_analytics.SCREEN_PAUSE)
  } catch (a) { }
  var getButtonTop = function (offset) {
    offset = offset || 14;
    //console.log('window.bannerTop', window.bannerTop, window.innerHeight);
    var bannerTop = window.bannerTop || (window.innerHeight - 60);
    //console.log('bannerTop', bannerTop);
    var winSize = wx.getSystemInfoSync();
    var top = (canvas.height * window.bannerTop) / winSize.windowHeight - offset;

    return top;
  };
  var top = getButtonTop()
  var top2 = getButtonTop(54)
  var t = {
    oImgData: assetLib.getData("uiButs"),
    //aPos: [0, 170],
    //align: [.5, .5],
    aPos: [0, top],
    align: [.5, 0],
    id: oImageIds.stopBut,
    noMove: !0,
    scale: 1e-4
  }, e = {
    oImgData: assetLib.getData("continue_video"),
    //aPos: [0, 45],
    //align: [.5, .5],
    aPos: [0, top2],
    align: [.5, 0],
    id: oImageIds.continueVideoBut,
    noMove: !1,
    scale: 1.2
  };//reading
  /*userInput.addHitArea("levelFailFromConfirm", butEventHandler, null, "image", t), */userInput.addHitArea("addOverTimeAndResume", butEventHandler, null, "image", e);
  //console.log('reading');
  setTimeout(function() {
    var realtop = getButtonTop();
    t.aPos = [0, realtop], t.scale = 1, userInput.addHitArea("levelFailFromConfirm", butEventHandler, null, "image", t);
    var realtop2 = getButtonTop(54)
    if (realtop2 < top2) {
      e.aPos = [0, realtop2];
      userInput.removeHitArea("addOverTimeAndResume")
      userInput.addHitArea("addOverTimeAndResume", butEventHandler, null, "image", e);
    }
  }, 2e3);
  var o = new Array(t, e);
  panel = new Elements.Panel(gameState, o), panel.startTween1(), previousTime = (new Date).getTime(), background = new Elements.Background("titleBg"), updateConfirmEvent()
}

function initGetBike(a) {
  window.showBannerAd(2)
  console.log("initGetBike")
  gameState = "getbike";
  try {
    window.famobi_analytics.trackScreen(famobi_analytics.SCREEN_PAUSE)
  } catch (e) { }
  ...
  var top = getButtonTop(14)
  var thanks = {
    oImgData: assetLib.getData("thanks"),
    aPos: [0, top],
    align: [.5, 0],
    id: oImageIds.thankBut,
    noMove: !0,
    scale: 1e-4
  }; 
  var top2 = getButtonTop(74)
  var share = {
    oImgData: assetLib.getData("receive"),
    //aPos: [(canvas.width) / 2, canvas.height * t + o * r - 5],
    //align: [0, 0],
    aPos: [0, top2],
    align: [.5, 0],
    scale: a == 1 ? 1e-4 : 1,
  ...
  userInput.addHitArea("playFromShare", butEventHandler, null, "image", t), 
    userInput.addHitArea("jusie_bikeshare", butEventHandler, null, "image", share),userInput.addHitArea("backFromShare", butEventHandler, null, "image", s);
  var o = new Array(t, s, thanks, share);
  setTimeout(function () {
    var realtop = getButtonTop();
    thanks.aPos = [0, realtop], thanks.scale = .5, userInput.addHitArea("backFromShare", butEventHandler, null, "image", thanks);
    if (a == 1) { return; }
    var realtop2 = getButtonTop(74)
    if(realtop2 < top2) { 
      share.aPos = [0, realtop2];
      userInput.removeHitArea("jusie_bikeshare")
      userInput.addHitArea("jusie_bikeshare", butEventHandler, null, "image", share);
    }
  }, 2e3);
  panel = new Elements.Panel(gameState, o), panel.startTween1(), previousTime = (new Date).getTime(), background = new Elements.Background("titleBg"), updateGetBikeEvent()
}

function initGetCoins(a) {
  window.showBannerAd(2)
  gameState = "getcoins";
  try {
    window.famobi_analytics.trackScreen(famobi_analytics.SCREEN_PAUSE)
  ...
  userInput.addHitArea("jusie_bikeshare", butEventHandler, null, "image", share);
  userInput.addHitArea("shopFromShare", butEventHandler, null, "image", t), userInput.addHitArea("bikeFromShare", butEventHandler, null, "image", e), userInput.addHitArea("backFromShare", butEventHandler, null, "image", s);
  var o = new Array(t, e, s, thanks, share);
  setTimeout(function () {
    var realtop = getButtonTop();
    thanks.aPos = [0, realtop], thanks.scale = .5, userInput.addHitArea("backFromShare", butEventHandler, null, "image", thanks);
    if (a == 1) { return; }
  ...
  panel = new Elements.Panel(gameState, o), panel.startTween1(), previousTime = (new Date).getTime(), background = new Elements.Background("titleBg"), updateGetCoinsEvent()
}

function initGetAccel(status) {

  console.log("加速道具获取jusie", status)
  ...
  isMobile ? (t = {
    ...
    align: [1, 1],
    id: oImageIds.playBut,
    scale: share==1 ? .75 : 1e-4,//status == 2 ? .75 : 1e-4,
    noMove: !0
  })
    : (
      t = {
  ...
  var k = {
    ...
    aPos: [0, top2],
    align: [.5, 0],
    scale: share == 1 ? 1e-4 : 1,
    id: "id72"
  }; userInput.addHitArea("jusie_toshare", butEventHandler, null, "image", k);
  userInput.addHitArea("playFromShare", butEventHandler, null, "image", t), userInput.addHitArea("backFromShare", butEventHandler, null, "image", s);

  if (status == 1) {//获得奖励
    gameState = "getAccel";
    var o = new Array(t, s, thanks, k);
    setTimeout(function () {
      var realtop = getButtonTop();
      thanks.aPos = [0, realtop], thanks.scale = .5, userInput.addHitArea("backFromShare", butEventHandler, null, "image", thanks);
      if (share == 1) { return; }
    ...
    if(realtop2 < top2) { 
      k.aPos = [0, realtop2];
      userInput.removeHitArea("jusie_toshare")
      userInput.addHitArea("jusie_toshare", butEventHandler, null, "image", k);
    }
    }, 2e3);
    // console.log("3657==>", q.oImgData.img)
    panel = new Elements.Panel(gameState, o), panel.startTween1(), previousTime = (new Date).getTime(), background = new Elements.Background("titleBg"), updateGetAccelEvent()
  }
...
function resumeGame() {
    window.famobi_analytics.trackScreen("SCREEN_LEVEL"), gameState = "game", engineInc = 0, road.curveTween && road.curveTween.resume();
    var a = {
        oImgData: assetLib.getData("uiButs"),
        //aPos: [-790, 30],
        //align: [1, 0],
    ...
    aa = {//加速按钮
        ...
        aPos: [-80, 200],
        align: [1, 0],
        id: isSuperAccelerating ? oImageIds.accOverBtn:oImageIds.accBtn,
        noMove: !1,
        scale:1
    };
    userInput.addHitArea("pause", butEventHandler, null, "image", a);
...
function flushAddCoinsEffect() {
  var timerCoins = 0, timerScore = 0;
  userInput.removeHitArea("getCoins"), userInput.removeHitArea("getDoubleCoins");

  totalLevelScore = (Math.round(curTime / 10) + 10 * oGameData.overtakes + 10 * oGameData.speedSecs + oGameData.coins) * oGameData.multiple;
  totalLevelCoins = Math.round(oGameData.coins + curTime / 10 + oGameData.overtakes + oGameData.speedSecs) * oGameData.multiple;

  totalLevelScore = totalLevelScore == 0 ? 100 * oGameData.multiple : totalLevelScore;
  totalLevelCoins = totalLevelCoins == 0 ? 100 * oGameData.multiple : totalLevelCoins;
  console.log('origin:', totalScore, totalCoins, oGameData.multiple);
  console.log('total:', totalLevelScore, totalLevelCoins);

  // 金币数字累加效果
  var addCoins = function (item, oldVal, newVal) {
    var minus = (newVal - oldVal).toString();
    var i = 0, t = parseInt(minus.charAt(minus.length - 1)), bit = 1;
    var timer = setInterval(function () {
      //console.log(oGameData.totalLevelCoins);
      if (i < t) {
        switch (item) {
          case "totalLevelCoins":
            oGameData.totalLevelCoins += Math.pow(10, bit - 1);
            totalCoins = Math.min(totalCoins + Math.pow(10, bit - 1), 99999);
            break;
          case "totalLevelScore":
            oGameData.totalLevelScore += Math.pow(10, bit - 1);
            totalScore = Math.min(totalScore + Math.pow(10, bit - 1), 99999)
            break;
        }
        i++;
      }
        ...
        if (minus.length - bit < 0) {
          ...
          t = parseInt(minus.charAt(minus.length - bit));
          i = 0;
        }
      }
    }, 50);
  ...
  var _totalScore = Math.min(totalScore + totalLevelScore, 99999);
  var _totalCoins = Math.min(totalCoins + totalLevelCoins, 99999);
  saveDataHandler.setTotalScore(_totalScore);
  saveDataHandler.setTotalCoins(_totalCoins);
  saveDataHandler.saveData();
  console.log('save:', _totalScore, _totalCoins)

  // 加金币效果
  addCoins("totalLevelCoins", oGameData.totalLevelCoins, totalLevelCoins);
  addCoins("totalLevelScore", oGameData.totalLevelScore, totalLevelScore);
}

function butEventHandler(a, t) {
  /*if (window.clickAD==true){
    console.log("===3471===")
    return
  }*/
    switch (a) {
        case "langSelect":
            curLang = t.lang, ctx.clearRect(0, 0, canvas.width, canvas.height), userInput.removeHitArea("langSelect"), preAssetLib = new Utils.AssetLoader(curLang, [{
                id: "preloadImage",
                file: window.REMOTE_SERVER_ROOT + "moto/images/preloadImage.jpg"
        ...
        console.log("playFromStart")
            ...
            , userInput.removeHitArea("SpecialList")
            , userInput.removeHitArea("credits")
            , userInput.removeHitArea("mute")
            , userInput.removeHitArea("shareGetCarOrCoin")
            , userInput.removeHitArea("shareGetAcce")
            , userInput.removeHitArea("friendShare")
              , window.adPlugin.hideBanner()
            //  , (window.bannerAdPlugin && window.bannerAdPlugin.hide())
            , initMapScreen();
            break;
        case "friendShare":

        if (window.specialList) return;
        console.log("3792==>friendshare")
            window.FriendShare(null, 1);
            break;
        case "shopFromStart":

        if (window.specialList) return;
        console.log("shopFromStart")
        //(window.bannerAd && window.destroyBannerAd());
        window.destroyBannerAd();
        playSound("click"), userInput.removeHitArea("playFromStart"), userInput.removeHitArea("shopFromStart"), userInput.removeHitArea("SpecialList"), userInput.removeHitArea("bikeFromStart"), userInput.removeHitArea("moreGames"), userInput.removeHitArea("credits"), userInput.removeHitArea("mute"), userInput.removeHitArea("shareGetCarOrCoin"), userInput.removeHitArea("shareGetAcce"), userInput.removeHitArea("friendShare"), initUpgradeScreen();
            break;
        case "shopFromShare":
        console.log("shopFromShare")
        window.destroyBannerAd();
        playSound("click"), userInput.removeHitArea("shopFromShare"), userInput.removeHitArea("bikeFromShare"), userInput.removeHitArea("backFromShare"), initUpgradeScreen();
          break;
        case"jusie_toshare":

        var fun = function () {
          saveDataHandler.setAccelCount(1), saveDataHandler.setCoinLeftTime(), saveDataHandler.saveData();
          share = 1
          // bindtapShare = 0
          // 引导到获取页面  
          userInput.removeHitArea("playFromShare"), userInput.removeHitArea("backFromShare"), userInput.removeHitArea("jusie_toshare"), initGetAccel(1);
         }
          console.log("jusie_toshare")
          window.FriendShare(fun,1); 
          break;

        case "jusie_bikeshare":
        console.log("3829")// 免费领取赛车
        var fun = function () {
          
          var t = saveDataHandler.getBikeCount();
          saveDataHandler.setBikeCount();
          0 != t && (totalCoins += /*1000*/window.gameConf.shareCoins, saveDataHandler.setTotalCoins(totalCoins));
          saveDataHandler.saveData();
          freeBikeshare = 1;
          // bindtapShare = 0
          // 引导到获取页面  
          userInput.removeHitArea("playFromShare"), userInput.removeHitArea("backFromShare"), userInput.removeHitArea("jusie_bikeshare"), t == 0 ? initGetBike(1) : initGetCoins(1);
        }

        //window.FriendShare(fun, 1); 
        var shareType = window.gameConf.shareTypeArr[0] || 0;
        switch (shareType) {
          case 0:
            fun();
            break;
          case 1:
            saveDataHandler.getBikeCount() == 0 ? window.FriendShare(fun, 2) : window.FriendShare(fun);
            break;
          case 2:
            window.showVideoAd(function (n) {
              if (n.isEnded == !0) {
                fun();
              };
            });
        ...
        console.log("分享获得加速")
            // 分享获得加速
        var k = window.FreedSpeedcheckLeftTime(saveDataHandler.getCoinLeftTime());
            if(k == !1) {
              var fun = function () {
                window.adPlugin.hideBanner();
                //添加倒计时old
                ...
                // 引导到获取页面
                //window.destroyBannerAd()
                userInput.removeHitArea("playFromStart"), userInput.removeHitArea("SpecialList"), userInput.removeHitArea("shopFromStart"), userInput.removeHitArea("bikeFromStart"), userInput.removeHitArea("moreGames"), userInput.removeHitArea("credits"), userInput.removeHitArea("mute"), userInput.removeHitArea("shareGetCarOrCoin"), userInput.removeHitArea("friendShare"), userInput.removeHitArea("shareGetAcce"), initGetAccel(1);
              };

              var shareType = window.gameConf.shareTypeArr[1] || 0;
              console.log("====shareType===", shareType)
              switch(/*window.gameConf.enableMultiple*/shareType) {
            ...
            else window.showToast('领取加速道具的时间还未到，稍后再来吧。');
            break;
        case "shareGetCarOrCoin":

        if (window.specialList) return;
        console.log("3809==>shareGetCarOrCoin")
            // 分享获得赛车/金币
            var t = saveDataHandler.getBikeCount();

            var k = (t != 0) ? window.checkLeftTime(t) : !1;
            console.log("3889==>t==>", t, "k==>", k)
            if (k == !1) {
              var fun = function () {
                //window.adPlugin.hideBanner();
                ...
                // 引导到获取页面
                //window.destroyBannerAd();
                userInput.removeHitArea("playFromStart"), userInput.removeHitArea("SpecialList"), userInput.removeHitArea("shopFromStart"), userInput.removeHitArea("bikeFromStart"), userInput.removeHitArea("moreGames"), userInput.removeHitArea("credits"), userInput.removeHitArea("mute")
                ,userInput.removeHitArea("shareGetCarOrCoin"), userInput.removeHitArea("friendShare"), userInput.removeHitArea("shareGetAcce"), 0 == t ? initGetBike() : initGetCoins();
                // setTimeout(function(){
                //   0 == t ? initGetBike() : initGetCoins();
                // },300)
              ...
              switch (/*window.gameConf.enableMultiple*/shareType) {
                ...
                case 1:
                  ...
                  freeBikeshare = 0
                  break;
                case 2: // 注：由于增加了一个新页面，原来观看视频后直接领取的功能失效
                  fun();
                  freeBikeshare = 0
                  /*console.log("===3856===")
                  window.showVideoAd(function (n) {
            ...
            else window.showToast('领取宝箱的时间还未到，稍后再来吧。');
            ...
            /*window.FriendShare(function() {
              ...
              if(k == !1) {
                saveDataHandler.setBikeCount();
                0 != t && (totalCoins += 1000, saveDataHandler.setTotalCoins(totalCoins));
                saveDataHandler.saveData();
                // 引导到获取页面
                userInput.removeHitArea("playFromStart"), userInput.removeHitArea("shopFromStart"), userInput.removeHitArea("bikeFromStart"), userInput.removeHitArea("moreGames"), userInput.removeHitArea("credits"), userInput.removeHitArea("mute"), userInput.removeHitArea("shareGetCarOrCoin"), userInput.removeHitArea("friendShare"), userInput.removeHitArea("shareGetAcce"), 0 == t ? initGetBike() : initGetCoins();
              }
            ...
            break;
        case "playFromShare":
        console.log("3857==>playFromTut")
            // reading
            window.destroyBannerAd();
            playSound("click")
            , userInput.removeHitArea("playFromShare")
            , userInput.removeHitArea("backFromShare")
            , userInput.removeHitArea("jusie_toshare")
            , initMapScreen();
            break;
        case "bikeFromStart":
        ...
        if (window.specialList) return;
        console.log("3866==>bikeFromStart")
        //(window.bannerAd && window.destroyBannerAd());
        window.destroyBannerAd();
        playSound("click"), userInput.removeHitArea("playFromStart"), userInput.removeHitArea("shopFromStart"), userInput.removeHitArea("bikeFromStart"), userInput.removeHitArea("SpecialList"), userInput.removeHitArea("moreGames"), userInput.removeHitArea("credits"), userInput.removeHitArea("mute"), userInput.removeHitArea("shareGetCarOrCoin"), userInput.removeHitArea("shareGetAcce"), userInput.removeHitArea("jusie_bikeshare"), userInput.removeHitArea("friendShare"), initBikeShopScreen();
            break;
        case "bikeFromShare":
        console.log("3870==>bikeFromShare")
        window.destroyBannerAd();
        playSound("click"), userInput.removeHitArea("shopFromShare"), userInput.removeHitArea("bikeFromShare"), userInput.removeHitArea("backFromShare"), initBikeShopScreen();
            break;
      case "SpecialList":
        if(window.specialList) return;

        console.log("SpecialList", window.HitinGame)
        window.flushLeftTime = true
        window.adPlugin.run({
          onCreate: function() {
            window.specialList = true
            window.hideBannerAd(true)
          },
          onDestroy: function() {
            window.specialList = false
            window.hideBannerAd(false)
          }
        });
        window.HitinGame = 1
        ...
        break;
        case "mapTouch":
            console.log("3436 ==> mapTouch")
            if (t.isBeingDragged && !t.hasLeft && mapTouchFirst)
              console.log("mapTouch1"),
             panel.mapPosX = Math.max(Math.min(panel.mapStartX - t.x, 1600 - canvas.width), 0), panel.mapPosY = Math.max(Math.min(panel.mapStartY - t.y, 1111 - canvas.height), 0);
            else if (t.isDown && 0 == t.isBeingDragged)
              console.log("mapTouch2"),
                playSound("click"), panel.mapTween && panel.mapTween.kill(), panel.mapStartX = panel.mapPosRealX + t.x, panel.mapDragX = t.x, panel.mapStartY = panel.mapPosRealY + t.y, panel.mapDragY = t.y, mapTouchFirst = !0;
            else if (mapTouchFirst && (mapTouchFirst = !1, Math.abs(panel.mapDragY - t.y) < 10)) window.adPlugin.hideBanner(),console.log("mapTouch3")
        ...
        console.log("3897==>calendarFromMap")
          var fun = function() {
            //(window.bannerAd && window.destroyBannerAd());
            window.destroyBannerAd();
          ...
          var shareType = window.gameConf.shareTypeArr[2] || 0;
          switch(/*window.gameConf.enableMultiple*/shareType) {
            case 0:
              fun();
              break;
       ...
       // (window.bannerAd && window.destroyBannerAd());
        ...
        case "buyUpgrade":
        console.log("3952")
            if (saveDataHandler.getBikeUpgrade(curBike, t.id) < 5) {//reading
              var p = (curBike < 3) ? (curBike + 3) : 5;
        ...
        console.log("3953==>backFromUpgrade")
        window.destroyBannerAd();
            playSound("click"), userInput.removeHitArea("backFromUpgrade"), userInput.removeHitArea("bikeFromUpgrade"), userInput.removeHitArea("upgradeLeft"), userInput.removeHitArea("upgradeRight"), userInput.removeHitArea("buyUpgrade"), userInput.removeHitArea("playFromUpgrade"), userInput.removeHitArea("mute"), /*initMapScreen()(window.bannerAd && window.destroyBannerAd()),*/ initStartScreen();
            break;
        ...
        console.log("3960==>playFromUpgrade")
        window.destroyBannerAd();
        ...
        case "buyBike":
            ...
            if (!saveDataHandler.hasBike(curBikeShopId)) {
                var discountCount = saveDataHandler.getDiscount(curBikeShopId),
                //discountList = bikeDiscountList;//new Array(0,0.1,0.1,0.1);
                  discountList = bikeDiscountList[curBikeShopId.toString()];
                //console.log('==', discountList);
                var h = aBikeData[curBikeShopId].cost;
                var price = h;
                //xiugai
              for (var count = 0; count <= discountCount; count++) {
                price = price - discountList[count] * h
              }
                
                h = Math.floor(price);
                totalCoins >= h && (totalCoins -= h, saveDataHandler.addBike(curBikeShopId), saveDataHandler.setTotalCoins(totalCoins), saveDataHandler.saveData(), curBike = curBikeShopId, userInput.removeHitArea("backFromBikeShop"), userInput.removeHitArea("shopFromBikeShop"), userInput.removeHitArea("bikeShopLeft"), userInput.removeHitArea("bikeShopRight"), userInput.removeHitArea("buyBike"), userInput.removeHitArea("onDiscount"), userInput.removeHitArea("playFromBikeShop"), userInput.removeHitArea("mute"), initBikeShopScreen(!0), playSound("buyBike"))
            }
            break;
        case "onDiscount":
            var discount = saveDataHandler.getDiscount(curBikeShopId),
              discountList = bikeDiscountList[curBikeShopId.toString()];
        if (discount < discountList.length - 1) {
                console.log("onDiscount2")
            //     var h = aBikeData[curBikeShopId].cost;
            //     totalCoins >= h && (totalCoins -= h, saveDataHandler.addBike(curBikeShopId), saveDataHandler.setTotalCoins(totalCoins), saveDataHandler.saveData(), curBike = curBikeShopId, userInput.removeHitArea("backFromBikeShop"), userInput.removeHitArea("shopFromBikeShop"), userInput.removeHitArea("bikeShopLeft"), userInput.removeHitArea("bikeShopRight"), userInput.removeHitArea("buyBike"), userInput.removeHitArea("playFromBikeShop"), userInput.removeHitArea("mute"), initBikeShopScreen(!0), playSound("buyBike"))
                var shareCun = 0
                var isShareDiscount = window.share.getData("isShareDiscount")[curBikeShopId.toString()] || [0,0]
                //console.log(isShareDiscount);
                //if(typeof(isShareDiscount) == "object")
                if(window.isCloseShareVersion()){
                    shareCun = isShareDiscount[0] || 0;
                }else{
                    shareCun = isShareDiscount[1] || 0;
                }
                //saveDataHandler.addDiscount(curBikeShopId);
                if(discount < shareCun){
                  console.log("===4044onHotShare===")
                    window.share.onHotShare(function(data){
                  ...
                  console.log("===4056===")
                    window.showVideoAd(function(isEnded){
        ...
        console.log("4033")
        window.destroyBannerAd();
        playSound("click"), userInput.removeHitArea("backFromBikeShop"), userInput.removeHitArea("shopFromBikeShop"), userInput.removeHitArea("bikeShopLeft"), userInput.removeHitArea("bikeShopRight"), userInput.removeHitArea("buyBike"), userInput.removeHitArea("onDiscount"), userInput.removeHitArea("playFromBikeShop"), userInput.removeHitArea("mute"), /*initMapScreen()(window.bannerAd && window.destroyBannerAd()),*/ initStartScreen();
            break;
        case "shopFromBikeShop":
        console.log("4037")
            window.destroyBannerAd();
            playSound("click"), userInput.removeHitArea("backFromBikeShop"), userInput.removeHitArea("shopFromBikeShop"), userInput.removeHitArea("bikeShopLeft"), userInput.removeHitArea("bikeShopRight"), userInput.removeHitArea("buyBike"), userInput.removeHitArea("onDiscount"),userInput.removeHitArea("playFromBikeShop"), userInput.removeHitArea("mute"), initUpgradeScreen();
            break;
        case "playFromBikeShop":
        console.log("4041")
            window.destroyBannerAd();
            saveDataHandler.hasBike(curBikeShopId) && (userInput.removeHitArea("backFromBikeShop"), userInput.removeHitArea("shopFromBikeShop"), userInput.removeHitArea("bikeShopLeft"), userInput.removeHitArea("bikeShopRight"), userInput.removeHitArea("buyBike"), userInput.removeHitArea("onDiscount"), userInput.removeHitArea("playFromBikeShop"), userInput.removeHitArea("mute"), initMapScreen(), playSound("click"));
            break;
        case "steerLeft":
            //console.log('steerLeft', t, t.isDown)
            leftSteer = t.isDown ? 1 : 0;
            break;
        case "steerRight":
            //console.log('steerRight', t, t.isDown)
            rightSteer = t.isDown ? -1 : 0;
            break;
        case "steerTouch":
            console.log('steerTouch')
        ...
        window.destroyBannerAd(); window.gameMusic.stop(), window.mainMusic.play();
        playSound("click"), userInput.removeHitArea("playFromLevelComplete"), userInput.removeHitArea("backFromLevelComplete"), userInput.removeHitArea("shopFromLevelComplete"), userInput.removeHitArea("bikeFromLevelComplete"), userInput.removeHitArea("mute"), userInput.removeHitArea("getDoubleCoins"), gameOver = !1,
          oGameData.multiple = 1, getDoubleCoins = !1, initMapScreen();
            break;
        case "getCoins":
            playSound("click");
            //console.log(totalCoins, totalLevelCoins);
            flushAddCoinsEffect();
        ...
        case "getDoubleCoins":
            playSound("click");
        console.log("===4120===")
            var shareType = window.gameConf.shareTypeArr[4] || 0;

            (getDoubleCoins == !1 && window.gameConf.enableMultiple != 0) && (
                /*window.gameConf.enableMultiple*/shareType == 0 ? (oGameData.multiple = 3, getDoubleCoins = !0, flushAddCoinsEffect()) : (shareType == 1 ?     window.FriendShare(function () {
                  oGameData.multiple = 3;
                  getDoubleCoins = !0;
                  //state == 'fail' ? initLevelFail() : initLevelComplete();
                  flushAddCoinsEffect();
                  //getDoubleCoinsCount++;
                }, 4) : 
                window.showVideoAd(function (n) {
        ...
        window.destroyBannerAd(); window.gameMusic.stop(), window.mainMusic.play();
        playSound("click"), userInput.removeHitArea("playFromLevelComplete"), userInput.removeHitArea("shopFromLevelComplete"), userInput.removeHitArea("bikeFromLevelComplete"), userInput.removeHitArea("mute"), userInput.removeHitArea("getDoubleCoins"), gameOver = !1,
          oGameData.multiple = 1, getDoubleCoins = !1, initUpgradeScreen();
            break;
        case "bikeFromLevelComplete":
        window.destroyBannerAd(); window.gameMusic.stop(), window.mainMusic.play();
        playSound("click"), userInput.removeHitArea("playFromLevelComplete"), userInput.removeHitArea("shopFromLevelComplete"), userInput.removeHitArea("bikeFromLevelComplete"), userInput.removeHitArea("mute"), userInput.removeHitArea("getDoubleCoins"), gameOver = !1,
          oGameData.multiple = 1, getDoubleCoins = !1, initBikeShopScreen();
            break;
        case "playFromLevelFail":
        window.destroyBannerAd();
            playSound("click"), userInput.removeHitArea("playFromLevelFail"), userInput.removeHitArea("backFromLevelFail"), userInput.removeHitArea("shopFromLevelFail"), userInput.removeHitArea("bikeFromLevelFail"), userInput.removeHitArea("mute"), userInput.removeHitArea("getDoubleCoins"), window.famobi_analytics.trackEvent(famobi_analytics.EVENT_LEVELRESTART, {
                levelName: (levelNum + 1).toString()
            }).then(initGame, initGame);
            break;
        case "backFromLevelFail":
        window.destroyBannerAd(); window.gameMusic.stop(), window.mainMusic.play();
        playSound("click"), userInput.removeHitArea("playFromLevelFail"), userInput.removeHitArea("backFromLevelFail"), userInput.removeHitArea("shopFromLevelFail"), userInput.removeHitArea("bikeFromLevelFail"), userInput.removeHitArea("getDoubleCoins"), userInput.removeHitArea("mute"), initMapScreen();
            break;
        case "backFromShare":
        window.destroyBannerAd();
        playSound("click"), userInput.removeHitArea("playFromShare"), userInput.removeHitArea("backFromShare"), userInput.removeHitArea("shopFromShare"), userInput.removeHitArea("bikeFromShare"), userInput.removeHitArea("jusie_bikeshare"), userInput.removeHitArea("jusie_toshare"), initStartScreen();
            break;
        case "shopFromLevelFail":
        window.destroyBannerAd(); window.gameMusic.stop(), window.mainMusic.play();
        playSound("click"), userInput.removeHitArea("playFromLevelFail"), userInput.removeHitArea("backFromLevelFail"), userInput.removeHitArea("shopFromLevelFail"), userInput.removeHitArea("bikeFromLevelFail"), userInput.removeHitArea("mute"), userInput.removeHitArea("getDoubleCoins"), initUpgradeScreen();
            break;
        case "bikeFromLevelFail":
        window.destroyBannerAd(); window.gameMusic.stop(), window.mainMusic.play();
            playSound("click"), userInput.removeHitArea("playFromLevelFail"), userInput.removeHitArea("backFromLevelFail"), userInput.removeHitArea("shopFromLevelFail"), userInput.removeHitArea("bikeFromLevelFail"), userInput.removeHitArea("mute"), userInput.removeHitArea("getDoubleCoins"), initBikeShopScreen();
            break;
        case "mute":
        ...
        console.log("4138")
        //window.adPlugin.showBanner();
            // isSuperAccelerating = !1;
            // road.maxSpeed = road.maxSpeed1;
            playSound("click"); 1 == audioType ? (Howler.mute(!0), playMusic()) : 2 == audioType && music.pause(), 
            userInput.removeHitArea("pause"), 
            userInput.removeHitArea("superSpeed"), 
            ...
            userInput.removeHitArea("mute"), initPause();
            break;
        case "superSpeed"://点击加速
            playSound("click");
            if(!isSuperAccelerating && !levelOver){
                var fun = function(){
                    console.log("road.maxSpeed = ",road.maxSpeed)
                    console.log("road.accRate = ",road.accRate)
                    // road.speed = road.maxSpeed;
                    isSuperAccelerating = !0;
                    isAccelerating = !0;
                    // hud.showWhoosh(1);
                    road.maxSpeed += road.maxSpeed*0.3;
                    road.accRate += road.accRate*1.3;
                    superAccelerating = 300
                    // setTimeout(function(){
                        // isSuperAccelerating = !1;
                        // road.maxSpeed = road.maxSpeed1;
                        // road.accRate = road.accRate1;
                    // },5000)
                    saveDataHandler.setAccelCount(-1);//edit
                    saveDataHandler.saveData();
                    panel.switchBut(oImageIds.accBtn, oImageIds.accOverBtn);
                }
                if(saveDataHandler.getAccelCount() > 0){
                    fun()
                }else{
                    if(window.share.getData("isShareGameAccelerate") == 1){
                      var gameSpeed = window.gameConf.gameSpeed;
                      console.log("4301==>gameSpeed==>", gameSpeed)
                      switch (/*window.gameConf.enableMultiple*/gameSpeed) {
                        case 0:
                        console.log("case0")
                          fun();
                          break;
                        ...
                        wx.showToast({ title: "道具不足！", icon:"none", duration: 1000 })
                    }
                }
            }
            break;
        case "addOverTimeAndResume":
            playSound("click");
            var fun = function() {
              window.destroyBannerAd();
              1 == audioType ? muted || (Howler.mute(!1), playMusic()) : 2 == audioType && (muted || playMusic()), userInput.removeHitArea("levelFailFromConfirm"), userInput.removeHitArea("addOverTimeAndResume"), curTime += /*500*/window.gameConf.overTime, gameOver = !0, hud.chequeredFlagX = 0, hud.raceEndState = 0,
                TweenLite.to(hud, .3, {
                  chequeredFlagX: -canvas.width,
                  ease: "Back.easeOut"
                }), setControl(), resumeGame();
            };
            //xxxxx
            var shareType = window.gameConf.shareTypeArr[3] || 0;
            switch(/*window.gameConf.enableMultiple*/shareType) {
              case 0:
                fun();
                break;
            ...
            break;
        case "levelFailFromConfirm":
        window.destroyBannerAd();
        playSound("click"), 1 == audioType ? muted || (Howler.mute(!1), playMusic()) : 2 == audioType && (muted || playMusic()), userInput.removeHitArea("levelFailFromConfirm"), userInput.removeHitArea("addOverTimeAndResume"), levelOver = !0, isAccelerating = !1, road.curveTween && road.curveTween.kill(),
initLevelFail();
          break;
...
function hasCrashed() {
    wx.vibrateLong({
      success: function () { console.log('振动成功') },
      fail: function() { console.log('振动失败') },
      complete: function() { console.log('振动调用完成') }
    });    // 振动效果
    sound.stop(), 
    ...
    road.speed *= 0/*.5*/, hud.showCrash(), //碰撞减速到0
    bike.showCrash(),isSuperAccelerating = !1,
    road.maxSpeed = road.maxSpeed1;
    road.accRate = road.accRate1;
    superAccelerating = 0;
    panel.switchBut(oImageIds.accOverBtn,oImageIds.accBtn);
}
...
function initLevelComplete() {
  //console.log(oGameData.multiple);
  console.log('innerHeight', window.innerHeight);
  window.innerHeight >=375 ? window.showBannerAd(4) : window.destroyBannerAd();
  state = 'complete'; getDoubleCoinsCount = 0;
  window.famobi_analytics.trackScreen(famobi_analytics.SCREEN_LEVELRESULT), gameState = "levelComplete", playSound("scoreTotal0"), background = new Elements.Background("Bg"), 1 == audioType && music.fade(music.volume(), .25, 500), /*oGameData.totalLevelScore = (Math.round(curTime / 10) + 10 * oGameData.overtakes + 10 * oGameData.speedSecs + oGameData.coins) * oGameData.multiple, oGameData.totalLevelCoins = Math.round(oGameData.coins + curTime / 10 + oGameData.overtakes + oGameData.speedSecs) * oGameData.multiple, totalScore = Math.min(totalScore + oGameData.totalLevelScore / oGameData.multiple, 99999), totalCoins = Math.min(totalCoins + oGameData.totalLevelCoins / oGameData.multiple, 99999), saveDataHandler.setTotalScore(totalScore), saveDataHandler.setTotalCoins(totalCoins),*//*调整为点击按钮后获取*/oGameData.totalLevelScore = 0, totalLevelScore = (Math.round(curTime / 10) + 10 * oGameData.overtakes + 10 * oGameData.speedSecs + oGameData.coins) * oGameData.multiple, oGameData.totalLevelCoins = 0, totalLevelCoins = Math.round(oGameData.coins + curTime / 10 + oGameData.overtakes + oGameData.speedSecs) * oGameData.multiple, isBonusLevel ? saveDataHandler.setCalendarComplete() : levelNum == saveDataHandler.getLastUnlockedLevel() && (saveDataHandler.setLevelComplete(levelNum), levelNum++), saveDataHandler.saveData(), playSound("levelComplete"), userInput.removeHitArea("mute"); 
    // 测试
    //totalLevelCoins += 1343;
    var a, t = {
            oImgData: assetLib.getData("continue"),
            aPos: [0, 60],
            //aPos: [80, 180],
            align: [.5, .5],
            id: oImageIds.continueRedBut,
            scale: 1e-4,
            noMove: !1
        },
        c = {
        ...
        d = {//temp
          ...
          aPos: [100, 70],
          align: [.5, .5],
          id: oImageIds.doubleCoinsBut,
          scale: 1.5
          /*oImgData: assetLib.getData("uiElements"),
          aPos: assetLib.getRealPos("uiElements", oImageIds.doubleCoinsBtn, 985, 380, ratio),
          align: [0, 0],
          id: oImageIds.doubleCoinsBtn,
          scale: ratio*/
        },
        e = {
            oImgData: assetLib.getData("uiButs"),
        ...
        (getDoubleCoins == !1 && /*oGameData.*/totalLevelCoins > 0 && !window.gameConf.enableMultiple) && (c.aPos = [0, 100]);  //111222
    a = saveDataHandler.getLatestBike() < 8 && totalCoins >= aBikeData[saveDataHandler.getLatestBike() + 1].cost ? {
            oImgData: assetLib.getData("uiButs"),
            aPos: [-70, -50],
            align: [1, 1],
        ...
        userInput.addHitArea("getDoubleCoins", butEventHandler, null, "image", d), 
        ...
        //console.log(getDoubleCoins);
  for (var i = (getDoubleCoins == !1 && /*oGameData.*/totalLevelCoins > 0) ? (window.gameConf.enableMultiple ? new Array(t, c, d, e, a) : new Array(t, c, e, a)) : new Array(t, e, a), s = 0; s < i.length; s++) "undefined" == typeof i[s].noMove && (i[s].doMove = !0), i[s].noMove = !0; t.noMove = !1;
    addMuteBut(i), panel = new Elements.Panel(gameState, i), panel.startLevelCompleteTween(), previousTime = (new Date).getTime();
    var o = function() {
        for (var s = 0; s < i.length; s++) i[s].doMove && (i[s].noMove = !1), i[s].scale == 1e-4 && (getDoubleCoins == !0 || /*oGameData.*/totalLevelCoins == 0) && (i[s].scale = 1);
      userInput.addHitArea("playFromLevelComplete", butEventHandler, null, "image", t), (getDoubleCoins == !1 && window.gameConf.enableMultiple && /*oGameData.*/totalLevelCoins > 0) && (userInput.addHitArea("getDoubleCoins", butEventHandler, null, "image", d)), (getDoubleCoins == !1 && /*oGameData.*/totalLevelCoins > 0) && (userInput.addHitArea("getCoins", butEventHandler, null, "image", c)), userInput.addHitArea("shopFromLevelComplete", butEventHandler, null, "image", e), userInput.addHitArea("bikeFromLevelComplete", butEventHandler, null, "image", a)
    };
    setTimeout(function() {
...
function initLevelFail() {
  window.innerHeight >= 375 ? window.showBannerAd(4) : window.destroyBannerAd();
  state = 'fail'; getDoubleCoinsCount = 0;
  window.famobi_analytics.trackScreen(famobi_analytics.SCREEN_LEVELRESULT), gameState = "levelFail", playSound("scoreTotal0"), background = new Elements.Background("Bg"), 1 == audioType && music.fade(music.volume(), .25, 500), /*oGameData.totalLevelScore = (10 * oGameData.overtakes + 10 * oGameData.speedSecs + oGameData.coins) * oGameData.multiple, oGameData.totalLevelCoins = (Math.round(oGameData.coins) + oGameData.overtakes + oGameData.speedSecs) * oGameData.multiple, totalScore = Math.min(totalScore + oGameData.totalLevelScore, 99999), totalCoins = Math.min(totalCoins + oGameData.totalLevelCoins, 99999), saveDataHandler.setTotalScore(totalScore), saveDataHandler.setTotalCoins(totalCoins), saveDataHandler.saveData(),*//*调整为点击按钮后获取*/oGameData.totalLevelScore = 0, totalLevelScore = (Math.round(curTime / 10) + 10 * oGameData.overtakes + 10 * oGameData.speedSecs + oGameData.coins) * oGameData.multiple, oGameData.totalLevelCoins = 0, totalLevelCoins = Math.round(oGameData.coins + curTime / 10 + oGameData.overtakes + oGameData.speedSecs) * oGameData.multiple, gameOver = !1, playSound("levelFail"), userInput.removeHitArea("mute");
  // 测试
  //totalLevelCoins += 1343;
    var a, b, c, t, e, i, p;
    if (totalCoins < 50) {
  ...
  //window.showToast('aa');
  //window.showToast(window.gameConf.enableMultiple);
  (getDoubleCoins == !1 && /*oGameData.*/totalLevelCoins > 0 && !window.gameConf.enableMultiple) && (c.aPos = [0, 90]);
  for (/*var s = new Array(a, b, e, i, t)*/var s = (getDoubleCoins == !1 && /*oGameData.*/totalLevelCoins > 0) ? (window.gameConf.enableMultiple ? new Array(a, b, c, e, i, t) : new Array(b, c, e, i, t)) : new Array(b, e, i, t), o = 0; o < s.length; o++) "undefined" == typeof s[o].noMove && (s[o].doMove = !0), s[o].noMove = !0; b.noMove = !1;
  ...
  var r = function () {
    //window.showToast('444');
      for (var o = 0; o < s.length; o++) s[o].doMove && (s[o].noMove = !1), s[o].scale == 1e-4 && (getDoubleCoins == !0 || /*oGameData.*/totalLevelCoins == 0) && (s[o].scale = 1); //hhhh
    (getDoubleCoins == !1 && window.gameConf.enableMultiple && /*oGameData.*/totalLevelCoins > 0) && userInput.addHitArea("getDoubleCoins", butEventHandler, null, "image", a), (getDoubleCoins == !1 && /*oGameData.*/totalLevelCoins > 0) && userInput.addHitArea("getCoins", butEventHandler, null, "image", c), userInput.addHitArea("playFromLevelFail", butEventHandler, null, "image", b), userInput.addHitArea("backFromLevelFail", butEventHandler, null, "image", t), userInput.addHitArea("shopFromLevelFail", butEventHandler, null, "image", e), userInput.addHitArea("bikeFromLevelFail", butEventHandler, null, "image", i)
    };
    setTimeout(function() {
...
function raceOver(a) {
  ...
  /*wx.stopAccelerometer({
    ...
    playSound(a ? "stageSuccess" : "raceFail"),
     ...
     levelOver = !0,
      ...
      //a = false,
       ...
       isSuperAccelerating = !1,
        a ? (
          hud.chequeredFlagX = -canvas.width,            hud.raceEndState = 0,
           TweenLite.to(hud, .3, {
        chequeredFlagX: 0,
        ease: "Back.easeOut"
    }), 
    TweenLite.to(road, 2, {
        ...
        ease: "Quad.easeOut",
        onComplete: function() {
            0 == controlMethod && wx && wx.stopAccelerometer && wx.stopAccelerometer();
            initLevelComplete()
        }
    }))
    ...
    TweenLite.to(road, 2, {
        //speed: .1 * aBikeData[curBike].minSpeed,
        speed: road.speed,    // 不减速
        ease: "Quad.easeOut",
        onComplete: function() {
            (gameOver == !1 && window.gameConf.enableMultiple) ? (
              levelOver = !1
     ...
     engineInc -= delta,
      ...
      engineInc = 1.5 * Math.random() + 6.5),
       levelOver || (curTime = Math.max(Math.round(curTime - 100 * delta), 0)),
        ...
        vehicleRate += road.speed * delta, vehicleRate >= vehicleRelease && (addVehicle(), 
        vehicleRelease = 130 * Math.random(), vehicleRate = 0), 
        isBonusLevel
         ? 
         
      (ctx.fillStyle = aSkyColours[aLevelData[bonusLevelNum].sky],
         ctx.fillRect(0, 0, canvas.width, canvas.height),
          ctx.fillStyle = aGroundColours[Math.floor(bonusLevelNum / 6)], 
          ctx.fillRect(0, road.horizon, canvas.width, canvas.height)) 
          
          :
      (ctx.fillStyle = aSkyColours[aLevelData[levelNum].sky],
            ctx.fillRect(0, 0, canvas.width, canvas.height),
...
function updateConfirmEvent() {
  "confirm" == gameState && (delta = getDelta(), background.render(), panel.render(), requestAnimFrame(updateConfirmEvent))
}

function updateGetBikeEvent() {
  "getbike" == gameState && (delta = getDelta(), background.render(), panel.update(), panel.render(), requestAnimationFrame(updateGetBikeEvent))
}

function updateGetCoinsEvent() {
  "getcoins" == gameState && (delta = getDelta(), background.render(), panel.update(), panel.render(), requestAnimationFrame(updateGetCoinsEvent))
}

function updateGetAccelEvent() {

  "getAccel" == gameState && (delta = getDelta(), background.render(), panel.update(), panel.render(), requestAnimationFrame(updateGetAccelEvent))
}
...
function loadPreAssets() {
    if (aLangs.length > 1) {
        for (var a = new Array, t = 0; t < aLangs.length; t++) a.push({
            id: "lang" + aLangs[t],
            file: window.REMOTE_SERVER_ROOT + "moto/images/lang" + aLangs[t] + ".png"
        });
        ...
        id: "loader",
        file: window.REMOTE_SERVER_ROOT + "moto/images/loader.png"
    }, {
        id: "loadSpinner",
        file: window.REMOTE_SERVER_ROOT + "moto/images/loadSpinner.png"
    }], ctx, canvas.width, canvas.height, (!1)), preAssetLib.onReady(initLoadAssets)
}
...
function loadAssets() {
    ...
    assetLib = new Utils.AssetLoader(curLang, [{
        id: "titleBg",
        file: window.REMOTE_SERVER_ROOT + "moto/images/titleBg.jpg"
    }, {
        id: "Bg",
        file: window.REMOTE_SERVER_ROOT + "moto/images/bg.jpg?10"
    }, {
        id: "splashLogo",
        file: window.REMOTE_SERVER_ROOT + "moto/images/splashLogo.png"
    }, {
        id: "flare",
        file: window.REMOTE_SERVER_ROOT + "moto/images/flare.png"
    }, 
    {
      id: "receive",//sepecialgame
      file: "images/receive.png",
      oAtlasData: {
        id72: {
          x: 0,
          y: 0,
      ...
      {
        id: "continue_video",
        file: "images/continue_video.png",
        oAtlasData: {
          id0: {
            x: 0,
            y: 0,
    ...
    {
        id: "uiButs",
        file: window.REMOTE_SERVER_ROOT + "moto/images/uiButs.png?103",
    ...
    {
      id: "bikeName",
      file: window.REMOTE_SERVER_ROOT + "moto/images/bike_name.png?1",
      oAtlasData: {
          id0: {
              x: 0,
              y: 39,
    ...
    {
        id: "uiElements",
        file: window.REMOTE_SERVER_ROOT + "moto/images/uiElements.png?9",
        oAtlasData: {
            id0: {
                x: 0,
                y: 0,
     ...
     {
        id: "hudElements",
        file: window.REMOTE_SERVER_ROOT + "moto/images/hudElements.png",
        oAtlasData: {
            id0: {
                x: 547,
                y: 0,
    ...
    {
        id: "road0",
        file: window.REMOTE_SERVER_ROOT + "moto/images/road0.jpg"
    }, {
        id: "road1",
        file: window.REMOTE_SERVER_ROOT + "moto/images/road1.jpg"
    }, {
        id: "road2",
        file: window.REMOTE_SERVER_ROOT + "moto/images/road2.jpg"
    }, {
        id: "road3",
        file: window.REMOTE_SERVER_ROOT + "moto/images/road3.jpg"
    }, {
        id: "road4",
        file: window.REMOTE_SERVER_ROOT + "moto/images/road4.jpg"
    }, {
        id: "bike0",
        file: window.REMOTE_SERVER_ROOT + "moto/images/bike0.png"
    }, {
        id: "bike1",
        file: window.REMOTE_SERVER_ROOT + "moto/images/bike1.png"
    }, {
        id: "bike2",
        file: window.REMOTE_SERVER_ROOT + "moto/images/bike2.png"
    }, {
        id: "bike3",
        file: window.REMOTE_SERVER_ROOT + "moto/images/bike3.png"
    }, {
        id: "bike4",
        file: window.REMOTE_SERVER_ROOT + "moto/images/bike4.png"
    }, {
        id: "bike5",
        file: window.REMOTE_SERVER_ROOT + "moto/images/bike5.png"
    }, {
        id: "bike6",
        file: window.REMOTE_SERVER_ROOT + "moto/images/bike6.png"
    }, {
        id: "bike7",
        file: window.REMOTE_SERVER_ROOT + "moto/images/bike7.png"
    }, {
        id: "bike8",
        file: window.REMOTE_SERVER_ROOT + "moto/images/bike8.png"
    }, {
        id: "vehicle0",
        file: window.REMOTE_SERVER_ROOT + "moto/images/truck0_472x168.png"
    }, {
        id: "sky0",
        file: window.REMOTE_SERVER_ROOT + "moto/images/sky0.png"
    }, {
        id: "sky1",
        file: window.REMOTE_SERVER_ROOT + "moto/images/sky1.png"
    }, {
        id: "sky2",
        file: window.REMOTE_SERVER_ROOT + "moto/images/sky2.png"
    }, {
        id: "sky3",
        file: window.REMOTE_SERVER_ROOT + "moto/images/sky3.png"
    }, {
        id: "sky4",
        file: window.REMOTE_SERVER_ROOT + "moto/images/sky4.png"
    }, {
        id: "numbers",
        file: window.REMOTE_SERVER_ROOT + "moto/images/numbers_41x47.png"
    }, {
        id: "calendarNumbers",
        file: window.REMOTE_SERVER_ROOT + "moto/images/calendarNumbers_13x19.png"
    }, {
        id: "crash",
        file: window.REMOTE_SERVER_ROOT + "moto/images/crash.png"
    }, {
        id: "coin",
        file: window.REMOTE_SERVER_ROOT + "moto/images/coin_89x126.png",
        oAnims: {
            spin: [0, 1, 2, 3, 4, 5, 6, 7, 8]
        }
    }, {
        id: "bonusCoin",
        file: window.REMOTE_SERVER_ROOT + "moto/images/coin2_88x125.png",
        oAnims: {
            spin: [0, 1, 2, 3, 4, 5, 6, 7, 8]
        }
    }, {
        id: "whoosh",
        file: window.REMOTE_SERVER_ROOT + "moto/images/whoosh.png"
    }, {
        id: "scenery",
        file: window.REMOTE_SERVER_ROOT + "moto/images/scenery.png",
        oAtlasData: {
            id0: {
                x: 405,
                y: 386,
        ...
        id: "map",
        file: window.REMOTE_SERVER_ROOT + "moto/images/map.jpg"
    }, {
        id: "vehicle1",
        file: window.REMOTE_SERVER_ROOT + "moto/images/car0_383x165.png"
    }, {
        id: "vehicle2",
        file: window.REMOTE_SERVER_ROOT + "moto/images/car1_383x165.png"
    }, {
        id: "vehicle3",
        file: window.REMOTE_SERVER_ROOT + "moto/images/car2_392x130.png"
    }, {
        id: "vehicle4",
        file: window.REMOTE_SERVER_ROOT + "moto/images/car3_392x130.png"
    }, 
    {
        id: "toShare",
      file: "https://api.jusie.net/pingpangqiu/moregame.png",
      oAtlasData: {
        id0: {
          x: 0,
          y: 0,
    ...
    {
        id: "sun",
        file: window.REMOTE_SERVER_ROOT + "moto/images/sun.png"
    }, {
        id: "garageBg",
        file: window.REMOTE_SERVER_ROOT + "moto/images/garageBg.jpg"
    }, {
        id: "moreGamesBut",
        file: a
      },
      {
        id: "bike",
        file: window.REMOTE_SERVER_ROOT + "moto/images/bike.png",
...
function resizeCanvas() {
    ...
    if (canvas.height = t, canvas.width = a, canvas.style.width = a + "px", canvas.style.height = t + "px", a > t ? canvas.height < minSquareSize ? (canvas.height = minSquareSize, canvas.width = minSquareSize * (a / t), canvasScale = minSquareSize / t) : canvas.height > maxSquareSize ? (canvas.height = maxSquareSize, canvas.width = maxSquareSize * (a / t), canvasScale = maxSquareSize / t) : canvasScale = 1 : canvas.width < minSquareSize ? (canvas.width = minSquareSize, canvas.height = minSquareSize * (t / a), canvasScale = minSquareSize / a) : canvas.width > maxSquareSize ? (canvas.width = maxSquareSize, canvas.height = maxSquareSize * (t / a), canvasScale = maxSquareSize / a) : canvasScale = 1, console.log('test',canvasScale,canvas.width,canvas.height),"game" == gameState) userInput.removeHitArea("steerRight"), userInput.removeHitArea("steerLeft"), userInput.removeHitArea("steerTouch"), userInput.removeKey("steerRight"), userInput.removeKey("steerLeft"), setControl();
        ...
        userInput.removeHitArea("upgradeLeft"), userInput.removeHitArea("upgradeRight"), userInput.removeHitArea("buyUpgrade"), userInput.removeHitArea("playFromUpgrade"), userInput.addHitArea("playFromUpgrade", butEventHandler, null, "rect", {
            ...
            aRect: [canvas.width / 2 - 275 - 45, canvas.height / 2 + 0 - 30, canvas.width / 2 - 275 + 45, canvas.height / 2 + 0 + 30]
        }, !0), userInput.addHitArea("upgradeRight", butEventHandler, null, "rect", {
            aRect: [canvas.width / 2 + 275 - 45, canvas.height / 2 + 0 - 30, canvas.width / 2 + 275 + 45, canvas.height / 2 + 0 + 30]
        }, !0);
        for (var i = new Array({
    ...
    } else if ("bikeShop" == gameState) userInput.removeHitArea("bikeShopLeft"), userInput.removeHitArea("bikeShopRight"), userInput.removeHitArea("buyBike"), userInput.removeHitArea("onDiscount"), userInput.removeHitArea("playFromBikeShop"), userInput.addHitArea("playFromBikeShop", butEventHandler, null, "rect", {
        aRect: [canvas.width / 2 - 60, canvas.height / 2 + 145 - 43, canvas.width / 2 + 60, canvas.height / 2 + 145 + 43]
    }, !0),  
    userInput.addHitArea("bikeShopLeft", butEventHandler, null, "rect", {
        aRect: [canvas.width / 2 - 275 - 45, canvas.height / 2 + 0 - 30, canvas.width / 2 - 275 + 45, canvas.height / 2 + 0 + 30]
    ...
    userInput.addHitArea("buyBike", butEventHandler, null, "rect", {
        aRect: [canvas.width / 2 - 165 - 80, canvas.height / 2 - 35 + 132 - 30, canvas.width / 2 + 0 - 20, canvas.height / 2 - 35 + 142 + 30]
    }, !1),
    userInput.addHitArea("onDiscount", butEventHandler, null, "rect", {
        aRect: [canvas.width / 2 + 20, canvas.height / 2 - 35 + 132 - 30, canvas.width / 2 + 250, canvas.height / 2 - 35 + 142 + 30]
    }, !1);
...
function toggleMute() {
    ...
    muted = !muted, window.muted1 = muted,1 == audioType ? muted ? (Howler.mute(!0),
      ...
      "game" == gameState ? music.volume(.5) : music.volume(.25)) : 2 == audioType && (muted ?
...
! function(a) {
    var t = function() {
        ...
        }, a.prototype.getRealPos = function(a, i, o, s, r) {
          var w = this.getData(a).oData.oAtlasData[i].width, h = this.getData(a).oData.oAtlasData[i].height;
          return [o * r + w / 2 * r, s * r + h / 2 * r];
        }, a
    }();
    a.AssetLoader = t
}(Utils || (Utils = {}));
    ...
    var t = function() {
        ...
        return a.prototype.updateAnimation = function(a) {
            ...
            if (null != this.animId) {
                ...
                s = Math.floor(this.fixedFrame / (this.oImgData.img.width / this.oImgData.oData.spriteWidth)) * this.oImgData.oData.spriteHeight;
            a.drawImage(this.oImgData.img, i, s, this.oImgData.oData.spriteWidth, this.oImgData.oData.spriteHeight, 
            
            
            this.x - (this.centreX - this.offsetX) * this.scaleX, 
            this.y - (this.centreY - this.offsetY) * this.scaleY, this.oImgData.oData.spriteWidth * this.scaleX, this.oImgData.oData.spriteHeight * this.scaleY)
...
! function(a) {
    var t = function() {
        ...
        return a.prototype.render = function() {
            if("Bg" == this.typeId) {
              var scale = canvas.width / this.oImgData.img.width;
              ctx.drawImage(this.oImgData.img, 0, 0, this.oImgData.img.width, this.oImgData.img.height, 0, 0, this.oImgData.img.width * scale, this.oImgData.img.height * scale);
            }
            else {
        ...
        return a.prototype.update = function() {
            ...
            switch ("undefined" == typeof a && (a = !0), a || this.addButs(ctx), this.panelType) {
              ...
              case "start":
                  //console.log('==start==')
                    var e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleLogo].x,
                        ...
                        r = Math.max(100 / s, .5 * canvas.width / s);
                        //console.log('==r==', r, s)
                    ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 - s / 2 * r - this.posY + 5, .15 * canvas.height - o / 2 * r, s * r, o * r);
                    var bikeImgData = assetLib.getData("bike")
                    e = bikeImgData.oData.oAtlasData["bike"+ (curBike +1)].x,
                    i = bikeImgData.oData.oAtlasData["bike"+ (curBike +1)].y,
                    s = bikeImgData.oData.oAtlasData["bike"+ (curBike +1)].width,
                    o = bikeImgData.oData.oAtlasData["bike"+ (curBike +1)].height//hhhh
                //ctx.drawImage(bikeImgData.img, e, i, s, o, canvas.width / 2 - s / 2 - 220 + this.posY, canvas.height / 2 - o / 2 + 50 - this.posY, s, o);//  [o * r + w / 2 * r, s * r + h / 2 * r]
                ctx.drawImage(bikeImgData.img, e, i, s, o, 215 * ratio, 180 * ratio, s * ratio, o * ratio);
                    var oSunImgData = assetLib.getData("sun")
                ctx.drawImage(oSunImgData.img, 0, 0, oSunImgData.img.width, oSunImgData.img.height, canvas.width / 2 - oSunImgData.img.width / 2 - 220, 0, oSunImgData.img.width, oSunImgData.img.height);
                var bikeNameImgData = assetLib.getData("bikeName");
                e = bikeNameImgData.oData.oAtlasData["id" + curBike].x,
                  i = bikeNameImgData.oData.oAtlasData["id" + curBike].y,
                  s = bikeNameImgData.oData.oAtlasData["id" + curBike].width,
                  o = bikeNameImgData.oData.oAtlasData["id" + curBike].height;
                ctx.drawImage(bikeNameImgData.img, e, i, s, o, 365 * ratio, 420 * ratio, s * ratio, o * ratio);
                    if (window.gameConf.enableMultiple != 0) {
                      var t = .7;
                      if (window.FreedSpeedcheckLeftTime(saveDataHandler.getCoinLeftTime()) == !1) {
                        ctx.save(), 
                        ctx.translate(100, canvas.height * t), 
                        ctx.scale(.75, .5), 
                        ...
                        this.switchBut(oImageIds.freeAccDisabled, oImageIds.freeAccBtn);
                      }
                      t = .5;
                      if (window.checkLeftTime(saveDataHandler.getBikeCount()) == !1) {
                        ctx.save(), ctx.translate(100, canvas.height * t), ctx.scale(.75, .5), ctx.rotate(this.flareRot), ctx.drawImage(this.oTopFlareImgData.img, -this.oTopFlareImgData.img.width / 2, -this.oTopFlareImgData.img.height / 2), ctx.restore();

                        this.switchBut(oImageIds.freeBoxDisabled, oImageIds.freeBoxBtn);
                      }
                ...
                case "credits":
                    ...
                    break;
                case "map":
                    this.mapPosRealY -= 8 * (this.mapPosRealY - this.mapPosY) * delta, this.mapPosRealX -= 8 * (this.mapPosRealX - this.mapPosX) * delta, 
                    ...
                    if (ctx.fillStyle = "rgba(0, 0, 0, 0.5)", 
                        ...
                        saveDataHandler.getCalendarStatus() && saveDataHandler.getLastUnlockedLevel() > 0 && (ctx.save(), 
                            ctx.translate(canvas.width - 70 - 40  + this.posY, canvas.height - 41 - 100), 
                            ctx.scale(1, .75), 
                            ctx.rotate(this.flareRot), 
                            ctx.drawImage(this.oTopFlareImgData.img, -this.oTopFlareImgData.img.width / 2, -this.oTopFlareImgData.img.height / 2), 
                            ctx.restore()), 
                        ...
                        ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width - s / 2 - 120 + this.posY, canvas.height - o / 2 - 41 - 100, s, o);
                        var c = g.getDate(),
                            u = c.toString();
                        u.length < 2 && (u = "0" + u);
                        for (var r = 1, I = 0; I < u.length; I++) {
                            ...
                            ctx.drawImage(this.oCalendarNumbersImgData.img, D, v, this.oCalendarNumbersImgData.oData.spriteWidth, this.oCalendarNumbersImgData.oData.spriteHeight, canvas.width - 70 - 110 + I * (13 * r) + this.posY, canvas.height - 46 - 100, this.oCalendarNumbersImgData.oData.spriteWidth * r, this.oCalendarNumbersImgData.oData.spriteHeight * r)
                        }
                    }
                    break;
                case "tut":
                ...
                //修改游戏中加速按钮下面数字
                    ...
                    ctx.font = "bolder 25px Helvetia";
                    ctx.textAlign = "center";
                    if (saveDataHandler.getAccelCount()>0){
                    ctx.fillText(saveDataHandler.getAccelCount(), canvas.width - 80 + this.posY, canvas.height /2 + 9,50);}
                    else{
                      ctx.fillText('免费加速', canvas.width - 80 + this.posY, canvas.height / 2 + 9, 50);
                    }
                    break;
                case "levelComplete":
                    if(getDoubleCoins == !0 && getDoubleCoinsCount == 0) {
                      for(var i = 0; i < this.aButs.length; i++) {
                        if (this.aButs[i].id == oImageIds.getCoinsBut) {
                          this.aButs[i].scale = 1e-4;
                          userInput.removeHitArea("getCoins");
                        }
                        else if(this.aButs[i].id == oImageIds.doubleCoinsBut) {
                          this.aButs[i].scale = 1e-4;
                          userInput.removeHitArea("getDoubleCoins");
                        }
                        else if (this.aButs[i].id == oImageIds.continueRedBut) {
                          this.aButs[i].scale = 1;
                          userInput.addHitArea("playFromLevelComplete", butEventHandler, null, "image", this.aButs[i]);
                        }
                      }

                      getDoubleCoinsCount = 1;
                    }
                    ...
                    ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 - s / 2 + this.posY, canvas.height / 2 - o / 2 - (25 + offsetY), s, o);
                    ...
                    ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 - 130 + this.posY, canvas.height / 2 - (140 + offsetY), s, o);
                    ...
                    ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 - 215 + this.posY, canvas.height / 2 - (170 + offsetY), s, o);
                    ...
                    ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 + 20 + this.endIconX0, canvas.height / 2 - (165 + offsetY), s, o), this.displayTime(canvas.width / 2 + 58 + this.endIconX0, canvas.height / 2 - (162 + offsetY));
                    ...
                    ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 + 20 + this.endIconX1, canvas.height / 2 - (125 + offsetY), s, o);
                    for (var u = oGameData.overtakes.toString(), r = .75, I = 0; I < u.length; I++) {
                        ...
                        ctx.drawImage(this.oNumbersImgData.img, D, v, this.oNumbersImgData.oData.spriteWidth, this.oNumbersImgData.oData.spriteHeight, canvas.width / 2 + 58 + this.endIconX1 + I * (numberSpace * r), canvas.height / 2 - (122 + offsetY), this.oNumbersImgData.oData.spriteWidth * r, this.oNumbersImgData.oData.spriteHeight * r)
                    }
                    ...
                    ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 + 20 + this.endIconX2, canvas.height / 2 - (85 + offsetY), s, o);
                    for (var u = oGameData.speedSecs.toString(), r = .75, I = 0; I < u.length; I++) {
                        var p = parseFloat(u.charAt(I)),
                            D = p * this.oNumbersImgData.oData.spriteWidth % this.oNumbersImgData.img.width,
                            v = Math.floor(p / (this.oNumbersImgData.img.width / this.oNumbersImgData.oData.spriteWidth)) * this.oNumbersImgData.oData.spriteHeight;
                        ctx.drawImage(this.oNumbersImgData.img, D, v, this.oNumbersImgData.oData.spriteWidth, this.oNumbersImgData.oData.spriteHeight, canvas.width / 2 + 58 + this.endIconX2 + I * (numberSpace * r), canvas.height / 2 - (82 + offsetY), this.oNumbersImgData.oData.spriteWidth * r, this.oNumbersImgData.oData.spriteHeight * r)
                    }
                    ...
                    ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 + 20 + this.endIconX3, canvas.height / 2 - (45 + offsetY), s, o);
                    for (var u = oGameData.coins.toString(), r = .75, I = 0; I < u.length; I++) {
                        var p = parseFloat(u.charAt(I)),
                            D = p * this.oNumbersImgData.oData.spriteWidth % this.oNumbersImgData.img.width,
                            v = Math.floor(p / (this.oNumbersImgData.img.width / this.oNumbersImgData.oData.spriteWidth)) * this.oNumbersImgData.oData.spriteHeight;
                        ctx.drawImage(this.oNumbersImgData.img, D, v, this.oNumbersImgData.oData.spriteWidth, this.oNumbersImgData.oData.spriteHeight, canvas.width / 2 + 58 + this.endIconX3 + I * (numberSpace * r), canvas.height / 2 - (42 + offsetY), this.oNumbersImgData.oData.spriteWidth * r, this.oNumbersImgData.oData.spriteHeight * r)
                    }
                    ...
                    for (var I = 0; I < u.length; I++) {
                        ...
                        var D = p * this.oNumbersImgData.oData.spriteWidth % this.oNumbersImgData.img.width,
                            v = Math.floor(p / (this.oNumbersImgData.img.width / this.oNumbersImgData.oData.spriteWidth)) * this.oNumbersImgData.oData.spriteHeight;
                        ctx.drawImage(this.oNumbersImgData.img, D, v, this.oNumbersImgData.oData.spriteWidth, this.oNumbersImgData.oData.spriteHeight, canvas.width / 2 - 146 + this.endIconX4 + I * (numberSpace * r), canvas.height / 2 + (10 - offsetY), this.oNumbersImgData.oData.spriteWidth * r, this.oNumbersImgData.oData.spriteHeight * r)
                    }
                    ...
                    for (var I = 0; I < u.length; I++) {
                        ...
                        var D = p * this.oNumbersImgData.oData.spriteWidth % this.oNumbersImgData.img.width,
                            v = Math.floor(p / (this.oNumbersImgData.img.width / this.oNumbersImgData.oData.spriteWidth)) * this.oNumbersImgData.oData.spriteHeight;
                        ctx.drawImage(this.oNumbersImgData.img, D, v, this.oNumbersImgData.oData.spriteWidth, this.oNumbersImgData.oData.spriteHeight, canvas.width / 2 + 63 + this.endIconX4 + I * (numberSpace * r), canvas.height / 2 + (10 - offsetY), this.oNumbersImgData.oData.spriteWidth * r, this.oNumbersImgData.oData.spriteHeight * r)
                    }
                    /*var t = .7;
                ...
                case "levelFail":
                    if (getDoubleCoins == !0 && getDoubleCoinsCount == 0) {
                      for (var i = 0; i < this.aButs.length; i++) {
                        if (this.aButs[i].id == oImageIds.getCoinsBut) {
                          ...
                          this.aButs[i].scale = 1;
                          userInput.addHitArea("playFromLevelFail", butEventHandler, null, "image", this.aButs[i]);
                        }
                      }
                    ...
                    ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 - 215 + this.posY, canvas.height / 2 - (160 + offsetY), s, o);
                    var e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.smallOvertakesIcon].x,
                        i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.smallOvertakesIcon].y,
                        s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.smallOvertakesIcon].width,
                        o = this.oUiElementsImgData.oData.oAtlasData[oImageIds.smallOvertakesIcon].height;
                    ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 + 20 + this.endIconX1, canvas.height / 2 - (145 + offsetY), s, o);
                    for (var u = oGameData.overtakes.toString(), r = .75, I = 0; I < u.length; I++) {
                        var p = parseFloat(u.charAt(I)),
                            D = p * this.oNumbersImgData.oData.spriteWidth % this.oNumbersImgData.img.width,
                            v = Math.floor(p / (this.oNumbersImgData.img.width / this.oNumbersImgData.oData.spriteWidth)) * this.oNumbersImgData.oData.spriteHeight;
                        ctx.drawImage(this.oNumbersImgData.img, D, v, this.oNumbersImgData.oData.spriteWidth, this.oNumbersImgData.oData.spriteHeight, canvas.width / 2 + 58 + this.endIconX1 + I * (numberSpace * r), canvas.height / 2 - (142 + offsetY), this.oNumbersImgData.oData.spriteWidth * r, this.oNumbersImgData.oData.spriteHeight * r)
                    }
                    var e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.smallSpeedSecsIcon].x,
                        i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.smallSpeedSecsIcon].y,
                        s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.smallSpeedSecsIcon].width,
                        o = this.oUiElementsImgData.oData.oAtlasData[oImageIds.smallSpeedSecsIcon].height;
                    ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 + 20 + this.endIconX2, canvas.height / 2 - (105 + offsetY), s, o);
                    for (var u = oGameData.speedSecs.toString(), r = .75, I = 0; I < u.length; I++) {
                        var p = parseFloat(u.charAt(I)),
                            D = p * this.oNumbersImgData.oData.spriteWidth % this.oNumbersImgData.img.width,
                            v = Math.floor(p / (this.oNumbersImgData.img.width / this.oNumbersImgData.oData.spriteWidth)) * this.oNumbersImgData.oData.spriteHeight;
                        ctx.drawImage(this.oNumbersImgData.img, D, v, this.oNumbersImgData.oData.spriteWidth, this.oNumbersImgData.oData.spriteHeight, canvas.width / 2 + 58 + this.endIconX2 + I * (numberSpace * r), canvas.height / 2 - (102 + offsetY), this.oNumbersImgData.oData.spriteWidth * r, this.oNumbersImgData.oData.spriteHeight * r)
                    }
                    var e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.smallCoinsIcon].x,
                        i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.smallCoinsIcon].y,
                        s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.smallCoinsIcon].width,
                        o = this.oUiElementsImgData.oData.oAtlasData[oImageIds.smallCoinsIcon].height;
                    ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 + 20 + this.endIconX3, canvas.height / 2 - (65 + offsetY), s, o);
                    for (var u = oGameData.coins.toString(), r = .75, I = 0; I < u.length; I++) {
                        var p = parseFloat(u.charAt(I)),
                            D = p * this.oNumbersImgData.oData.spriteWidth % this.oNumbersImgData.img.width,
                            v = Math.floor(p / (this.oNumbersImgData.img.width / this.oNumbersImgData.oData.spriteWidth)) * this.oNumbersImgData.oData.spriteHeight;
                        ctx.drawImage(this.oNumbersImgData.img, D, v, this.oNumbersImgData.oData.spriteWidth, this.oNumbersImgData.oData.spriteHeight, canvas.width / 2 + 58 + this.endIconX3 + I * (numberSpace * r), canvas.height / 2 - (62 + offsetY), this.oNumbersImgData.oData.spriteWidth * r, this.oNumbersImgData.oData.spriteHeight * r)
                    }
                    var u = oGameData.totalLevelScore.toString(),
                        r = .85;
                    for ("0" == u && (u = "|"); u.length < 5;) u = "|" + u;
                ...
                case "upgrade":
                    ...
                    ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 - s / 2 + this.posY, canvas.height / 2 - o / 2 - offsetY, s, o);
                    var r = .5,
                ...
                ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 - 120 + this.posY, canvas.height / 2 - 130 - offsetY, s * r, o * r);
                ...
                ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 - 17 + this.posY, canvas.height / 2 - 105 - offsetY, s, o);
                    for (var A = new Array({
                        ...
                        for (var I = 0; I < saveDataHandler.getBikeUpgrade(curBike, m); I++) {
                          ...
                          ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, A[m].x + 26 * I + this.posY, A[m].y - offsetY, s, o)
                        }
                    A = new Array({
                        x: canvas.width / 2 - 90,
                        y: canvas.height / 2 - 5
                    ...
                    for (var m = 0; m < A.length; m++)
                        if (saveDataHandler.getBikeUpgrade(curBike, m) < 5) {
                            ...
                            x = upgradeBaseCost + upgradeInc * saveDataHandler.getBikeUpgrade(curBike, m) + curBike * upgradeBikeInc; //console.log(upgradeBaseCost, upgradeInc, saveDataHandler.getBikeUpgrade(curBike, m), curBike, upgradeBikeInc);//here
                            x = x * p;
                          totalCoins >= x && (k = oImageIds.smallBuyButOn, ctx.save(), ctx.translate(A[m].x + this.posY, A[m].y - offsetY), ctx.scale(.6, .2), ctx.rotate(this.flareRot), ctx.drawImage(this.oTopFlareImgData.img, -this.oTopFlareImgData.img.width / 2, -this.oTopFlareImgData.img.height / 2 - offsetY), ctx.restore(), ctx.save(), ctx.translate(A[m].x + this.posY, A[m].y - offsetY), ctx.scale(.6, .2), ctx.rotate(-this.flareRot), ctx.drawImage(this.oTopFlareImgData.img, -this.oTopFlareImgData.img.width / 2, -this.oTopFlareImgData.img.height / 2 - offsetY), ctx.restore());
                          ...
                          ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, A[m].x - s / 2 + this.posY, A[m].y - o / 2 - offsetY, s, o);
                            for (var u = x.toString(), r = .5, I = 0; I < u.length; I++) {
                                var p = parseFloat(u.charAt(I)),
                                    D = p * this.oNumbersImgData.oData.spriteWidth % this.oNumbersImgData.img.width,
                                    v = Math.floor(p / (this.oNumbersImgData.img.width / this.oNumbersImgData.oData.spriteWidth)) * this.oNumbersImgData.oData.spriteHeight;
                              ctx.drawImage(this.oNumbersImgData.img, D, v, this.oNumbersImgData.oData.spriteWidth, this.oNumbersImgData.oData.spriteHeight, A[m].x + I * (numberSpace * r) + this.posY - 22, A[m].y - 12 - offsetY, this.oNumbersImgData.oData.spriteWidth * r, this.oNumbersImgData.oData.spriteHeight * r)
                            }
                        }
                    if (curBike > 0) {
                      ...
                      ctx.drawImage(this.oUiButsImgData.img, e, i, s, o, canvas.width / 2 - s / 2 - 275 + this.posY, canvas.height / 2 - o / 2 + 0 - offsetY, s, o)
                    }
                ...
                ctx.drawImage(this.oUiButsImgData.img, e, i, s, o, canvas.width / 2 - s / 2 * r + this.posY, canvas.height / 2 - o / 2 * r + 145 - offsetY, s * r, o * r);*/
                    break;
                case "bikeShop":
                    var offsetY = 40;
                    ctx.fillStyle = "rgba(0, 0, 0, 0.35)", ctx.fillRect(0, 0, canvas.width, canvas.height), this.displayScoreCoins();
                ...
                ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 - 200 + this.posY, canvas.height / 2 - 105 - offsetY, s * r, o * r);
                ...
                ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 - 200 + this.posY, canvas.height / 2 - 130 - offsetY, s, o);
                    for (var B = new Array("maxSpeed", "accRate", "maxSteer", "steerRate"), L = new Array(.07, .03, .05, .01), m = 0; m < 4; m++) {
                      ...
                      ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 + 54 + this.posY, canvas.height / 2 - 103 + 35 * m - offsetY, s * T, o)
                    }
                    if (saveDataHandler.hasBike(curBikeShopId)) {
                        /*var r = .75,
                            e = this.oUiButsImgData.oData.oAtlasData[oImageIds.playBut].x,
                      ...
                      ctx.drawImage(this.oUiButsImgData.img, e, i, s, o, canvas.width / 2 - s / 2 * r + this.posY, canvas.height / 2 - o / 2 * r + 145 - offsetY, s * r, o * r)*/
                        ...
                        var discountCount = saveDataHandler.getDiscount(curBikeShopId),
                        //discountList = bikeDiscountList;  //xiugai
                        discountList = bikeDiscountList[curBikeShopId.toString()];
                        //console.log('==discountList==', discountList);
                        var price = x;
                        //xiugai
                        for (var count = 0; count <= discountCount; count++) {
                          price = price - discountList[count] * x
                        }
                        ...
                        if (totalCoins >= price) {
                            ...
                            var t = .7;
                            ctx.save(), 
                            ctx.translate(canvas.width / 2 - 120 + this.posY, canvas.height / 2 + 72),
                            ctx.scale(1, .5), 
                            ctx.rotate(this.flareRot), 
                            ctx.drawImage(this.oTopFlareImgData.img, -this.oTopFlareImgData.img.width / 2, -this.oTopFlareImgData.img.height / 2), 
                            ctx.restore(), 
                            ctx.save(), 
                            ctx.translate(canvas.width / 2 - 120 + this.posY, canvas.height / 2 + 72), 
                            ctx.scale(1, .5), ctx.rotate(-this.flareRot), 
                            ctx.drawImage(this.oTopFlareImgData.img, -this.oTopFlareImgData.img.width / 2, -this.oTopFlareImgData.img.height / 2 - offsetY), 
                            ctx.restore()
                        }
                        var e = this.oUiElementsImgData.oData.oAtlasData[k].x,
                            i = this.oUiElementsImgData.oData.oAtlasData[k].y,
                            s = this.oUiElementsImgData.oData.oAtlasData[k].width,
                            o = this.oUiElementsImgData.oData.oAtlasData[k].height;
                      ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 - 250 + this.posY, canvas.height / 2 - 35 + 102 - offsetY, s, o);
                        
                        
                        for (var u = price.toString(), r = 1, I = 0; I < u.length; I++) {
                            var p = parseFloat(u.charAt(I)),
                                D = p * this.oNumbersImgData.oData.spriteWidth % this.oNumbersImgData.img.width,
                                v = Math.floor(p / (this.oNumbersImgData.img.width / this.oNumbersImgData.oData.spriteWidth)) * this.oNumbersImgData.oData.spriteHeight;
                          ctx.drawImage(this.oNumbersImgData.img, D, v, this.oNumbersImgData.oData.spriteWidth, this.oNumbersImgData.oData.spriteHeight, canvas.width / 2 + I * (numberSpace * r) + this.posY - 190, canvas.height / 2 + 78 - offsetY, this.oNumbersImgData.oData.spriteWidth * r, this.oNumbersImgData.oData.spriteHeight * r)
                        }
                        ctx.fillStyle = '#000000';
                        ctx.font = "bolder 18px Helvetia";
                        ctx.textAlign = "center";
                      ctx.fillText("价格：" + x.toString(), canvas.width / 2 - 110 + this.posY, canvas.height / 2 + 48 - offsetY);//xiugai
                      if (discountCount < discountList.length - 1){
                            var e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.discountBtn].x,
                                i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.discountBtn].y,
                                s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.discountBtn].width,
                                o = this.oUiElementsImgData.oData.oAtlasData[oImageIds.discountBtn].height;
                          ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 + 10 + this.posY, canvas.height / 2 - 35 + 102 - offsetY, s, o);
                            ctx.save()
                            //设置文字阴影的颜色为黑色，透明度为20%
                            ...
                            // 轻微模糊阴影
                            // ctx.shadowBlur = 2;
                            ctx.font = "italic bolder 40px Helvetia";
                            ctx.strokeStyle = '#000000'
                            ctx.fillStyle = '#cc0000';
                          ctx.fillText("-" + discountList[discountCount + 1] * 100 + "%", canvas.width / 2 + 75 + this.posY, canvas.height / 2 + 115 - offsetY);
                            ctx.restore()
                            ctx.font = "italic bolder 40px Helvetia";
                            ctx.strokeStyle = '#222222'
                            ctx.textAlign = "center";
                          ctx.strokeText("-" + discountList[discountCount + 1] * 100 + "%", canvas.width / 2 + 75 + this.posY, canvas.height / 2 + 115 - offsetY);
                        }
                    }
                    if (curBikeShopId > 0) {
                        var e = this.oUiButsImgData.oData.oAtlasData[oImageIds.leftBut].x,
                ...
                case "getbike":
                  ...
                  ctx.fillRect(0, 0, canvas.width, canvas.height);
                if (freeBikeshare == 1) { // 领取成功后再显示光照效果
                ...
                var _curBike = freeBikeshare == 1 ? curBike : curBike + 1
                var r = 1,
                  e = this.oUiElementsImgData.oData.oAtlasData[oImageIds["bikeIcon" + _curBike]].x,
                  i = this.oUiElementsImgData.oData.oAtlasData[oImageIds["bikeIcon" + _curBike]].y,
                  s = this.oUiElementsImgData.oData.oAtlasData[oImageIds["bikeIcon" + _curBike]].width,
                  o = this.oUiElementsImgData.oData.oAtlasData[oImageIds["bikeIcon" + _curBike]].height;
                // console.log("7028=>", curBike)
                ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 - s / 2 * r - this.posY, canvas.height * t - o / 2 * r, s * r, o * r);
                // 文字
                /*var getButtonTop = function () {
                  var bannerTop = 120;
                  var winSize = wx.getSystemInfoSync();
                  var top = (canvas.height * canvas.height * t) / winSize.windowHeight - 14;
                ...
                // console.log("7047=>",freeBikeshare)
                if (freeBikeshare == 1) {
                  ctx.fillStyle = '#ffffff';
                  ctx.font = "bolder 30px Helvetia";
                  ctx.textAlign = "center";
                  ctx.fillText('领取豪车一辆，赶快试驾吧！', canvas.width / 2, canvas.height * t + o * r);

                  //userInput.removeHitArea("jusie_bikeshare", butEventHandler, null, "image", toshare);
                }
                else {

                  //userInput.addHitArea("jusie_bikeshare", butEventHandler, null, "image", toshare)
                  //ctx.drawImage(toshare.oImgData.img, (canvas.width) / 2 - 125, canvas.height * t + o * r - 50)
                  //ctx.fillStyle = '#ffffff';
                  //ctx.font = "bolder 30px Helvetia";
                  //ctx.textAlign = "center";
                  //ctx.fillText('点击领取豪车！', canvas.width / 2, canvas.height * t + o * r + 10);
                }

                /*var 
                  toshare = {
                  oImgData: assetLib.getData("receive"),
                  aPos: [(canvas.width) / 2, canvas.height * t + o * r + 20],
                  align: [0, 0],
                  id: "id72",
                  scale: (freeBikeshare == 0) ? 1 : 1e-4
                  };
                // console.log("7047=>",freeBikeshare)
                if (freeBikeshare == 1) {
                  ctx.fillStyle = '#ffffff';
                  ctx.font = "bolder 30px Helvetia";
                  ctx.textAlign = "center";
                  ctx.fillText('领取豪车一辆，赶快试驾吧！', canvas.width / 2, canvas.height * t + o * r + 10);
                  ...
                  ctx.drawImage(toshare.oImgData.img, (canvas.width) / 2 - 125, canvas.height * t + o * r + 10)
                  //ctx.fillStyle = '#ffffff';
                  //ctx.font = "bolder 30px Helvetia";
                  //ctx.textAlign = "center";
                  //ctx.fillText('点击领取豪车！', canvas.width / 2, canvas.height * t + o * r + 10);
                ...
                // 手指
                /*this.playBtnPosRealY ? (this.up ? (this.playBtnPosRealY -= 10) : (this.playBtnPosRealY += 10), this.up = !this.up) : (this.playBtnPosRealY = this.playBtnPosY = canvas.height - 124 - 60, this.up = false);
                console.log('手指：', this);
                this.playBtnPosRealY -= 8 * (this.playBtnRealY - this.playBtnPosY) * delta;
                console.log(this.playBtnPosRealY)*/

                /*var w = 165, h = 124;
                w += 97, h += 67;
                r = isMobile ? .75 : 1;
                e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.fingerPoint].x,
                  i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.fingerPoint].y,
                  s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.fingerPoint].width,
                  o = this.oUiElementsImgData.oData.oAtlasData[oImageIds.fingerPoint].height;
                ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width - w / 2 * r, canvas.height - h * r - 60, s * r, o * r)*/
                  break;
              case "getcoins":
                  var t = .3;
                  ctx.fillStyle = "rgba(0, 0, 0, 0.5)";
                ...
                if (freeBikeshare == 1) { // 领取成功后再显示光照效果
                  ctx.save(), ctx.translate(canvas.width / 2 + this.posY, canvas.height * t), ctx.scale(.75, .5), ctx.rotate(this.flareRot), ctx.drawImage(this.oTopFlareImgData.img, -this.oTopFlareImgData.img.width / 2, -this.oTopFlareImgData.img.height / 2), ctx.restore(), ctx.save(), ctx.translate(canvas.width / 2 + this.posY, canvas.height * t), ctx.scale(1, .75), ctx.rotate(-this.flareRot), ctx.drawImage(this.oTopFlareImgData.img, -this.oTopFlareImgData.img.width / 2, -this.oTopFlareImgData.img.height / 2), ctx.restore(); }
                  var r = 2,
                    e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.coinIcon2].x,
                    i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.coinIcon2].y,
                    s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.coinIcon2].width,
                    o = this.oUiElementsImgData.oData.oAtlasData[oImageIds.coinIcon2].height;
                  ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 - s / 2 * r - this.posY, canvas.height * t - o / 2 * r, s * r, o * r);
                  // 文字
                ...
                if (freeBikeshare == 1) {
                  ...
                  ctx.font = "bolder 30px Helvetia";
                  ctx.textAlign = "center";
                  ctx.fillText('成功领取' + window.gameConf.shareCoins + '金币，赶快升级装备吧！', canvas.width / 2, canvas.height * t + o * 1.5);
                  ...
                  //ctx.font = "bolder 30px Helvetia";
                  //ctx.textAlign = "center";
                  //ctx.fillText('点击领取1000金币！', canvas.width / 2, canvas.height * t + o * r + 10);
                }
              ...
              case "getAccel":
                  ...
                  ctx.fillStyle = "rgba(0, 0, 0, 0.5)";
                  ctx.fillRect(0, 0, canvas.width, canvas.height);
                if (share == 1) { // 领取成功后再显示光照效果
                  ctx.save(), 
                  ctx.translate(canvas.width / 2 + this.posY, canvas.height * t), ctx.scale(.75, .5), ctx.rotate(this.flareRot), 
                  ctx.drawImage(this.oTopFlareImgData.img, -this.oTopFlareImgData.img.width / 2, -this.oTopFlareImgData.img.height / 2), 
                  ctx.restore(), ctx.save(), ctx.translate(canvas.width / 2 + this.posY, canvas.height * t), ctx.scale(1, .75), ctx.rotate(-this.flareRot), ctx.drawImage(this.oTopFlareImgData.img, -this.oTopFlareImgData.img.width / 2, -this.oTopFlareImgData.img.height / 2), ctx.restore(); }
                  var r = 2,
                    e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.accBtn].x,
                    i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.accBtn].y,
                    s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.accBtn].width,
                    o = this.oUiElementsImgData.oData.oAtlasData[oImageIds.accBtn].height;
                  ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 - s / 2 * r - this.posY, canvas.height * t - o / 2 * r, s * r, o * r);
                  // 文字
                /*var
                  toshare = {
                ...
                if (share == 1) {
                  ...
                  ctx.font = "bolder 30px Helvetia";
                  ctx.textAlign = "center";
                  ctx.fillText('成功领取，赶紧去试驾吧！', canvas.width / 2, canvas.height * t + o * 1.5);
                  //userInput.removeHitArea("jusie_toshare", butEventHandler, null, "image", toshare);
                  ...
                  //userInput.addHitArea("jusie_toshare", butEventHandler, null, "image", toshare)
                  //ctx.drawImage(toshare.oImgData.img, (canvas.width) / 2 - 125, canvas.height * t + o * r - 50)
                  //ctx.fillStyle = '#ffffff';
                  //ctx.font = "bolder 30px Helvetia";
                  //ctx.textAlign = "center";
                  //ctx.fillText('点击领取加速道具！', canvas.width / 2, canvas.height * t + o * r + 10);
                  }
              ...
              case "confirm":
                    if (ctx.fillStyle = "rgba(0, 0, 0, 0.5)", ctx.fillRect(0, 0, canvas.width, canvas.height), isMobile) {
                      var r = 1, t = .3,
                        ...
                        s = this.oUiElementsImgData.oData.oAtlasData[oImageIds["bikeIcon" + curBike]].width,
                        o = this.oUiElementsImgData.oData.oAtlasData[oImageIds["bikeIcon" + curBike]].height;
                      //console.log(e, i, s, o, canvas.width / 2 - s / 2 * r - this.posY, canvas.height * t - o / 2 * r, s * r, o * r);
                      ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 - s / 2 * r - this.posY, canvas.height * t - o / 2 * r, s * r, o * r);
                      // 文字
                      ctx.fillStyle = '#ffffff';
                      ctx.font = "bolder 30px Helvetia";
                      ctx.textAlign = "center";
                      var dTime = gameConf.overTime / 100;
                      ctx.fillText('增加' + dTime.toString() + '秒继续？', canvas.width / 2, canvas.height * t + o * r - 35);
                    }
                    break;
                case "pause":
                    if (ctx.fillStyle = "rgba(0, 0, 0, 0.5)", ctx.fillRect(0, 0, canvas.width, canvas.height), isMobile) {
            ...
            a && this.addButs(ctx)
        }, a.prototype.displayLeftTime = function() {
          var m = window.getLeftTimeFormatString(saveDataHandler.getBikeCount());
          if(m != '') {
            for (var a = .6, o = 0; o < m.length; o++) {
              var r;
              r = ":" == m.charAt(o) ? 10 : parseFloat(m.charAt(o));
              ...
              ctx.drawImage(this.oNumbersImgData.img, h, n, this.oNumbersImgData.oData.spriteWidth, this.oNumbersImgData.oData.spriteHeight, 80 + o * (numberSpace * a) - this.posY - 27, 280 - this.posY * ratio, this.oNumbersImgData.oData.spriteWidth * a, this.oNumbersImgData.oData.spriteHeight * a)
            }
          }
          m = window.FreedSpeedgetLeftTimeFormatString(saveDataHandler.getCoinLeftTime());
          if (m != '') {
            for (var a = .6, o = 0; o < m.length; o++) {
              var r;
              r = ":" == m.charAt(o) ? 10 : parseFloat(m.charAt(o));
              var h = r * this.oNumbersImgData.oData.spriteWidth % this.oNumbersImgData.img.width,
                n = Math.floor(r / (this.oNumbersImgData.img.width / this.oNumbersImgData.oData.spriteWidth)) * this.oNumbersImgData.oData.spriteHeight;
              ctx.drawImage(this.oNumbersImgData.img, h, n, this.oNumbersImgData.oData.spriteWidth, this.oNumbersImgData.oData.spriteHeight, 80 + o * (numberSpace * a) - this.posY - 27, 380 - this.posY * ratio, this.oNumbersImgData.oData.spriteWidth * a, this.oNumbersImgData.oData.spriteHeight * a)
            }
          }
...
! function(a) {
    var t = function() {
        function t() {
            ...
            this.scrollInc = 0, 
            this.skyScale = 1, 
            isBonusLevel ? (this.oRoadImgData = assetLib.getData("road" + Math.floor(bonusLevelNum / 6)), this.oSkyImgData = assetLib.getData("sky" + aLevelData[bonusLevelNum].sky)) : (this.oRoadImgData = assetLib.getData("road" + Math.floor(levelNum / 6)), this.oSkyImgData = assetLib.getData("sky" + aLevelData[levelNum].sky)), this.aRowData = new Array;
            ...
            this.maxSpeed1 = this.maxSpeed;
            this.accRate1 = this.accRate;
        ...
        return t.prototype.addScenery = function() {
            ...
            this.sceneryInc > 5.7 && (this.sceneryInc = 0, this.addScenery());
            // if(isAccelerating){
            //     this.speed -= (this.speed - this.maxSpeed) * (this.accRate * delta)
            // }else{
            //     this.speed -= (this.speed - this.minSpeed) * (this.accRate * delta)
            // }
            // oGameData.dist += this.speed / this.raceDist / 18e4 * (60 * delta);
            // if(0 == oGameData.levelStage && oGameData.dist >= 1 / 3 && !levelOver){
            //     (hud.hitCheckPoint(), oGameData.levelStage = 1)
            // }else{
            //     if(1 == oGameData.levelStage && oGameData.dist >= 2 / 3 && !levelOver){
            //         (hud.hitCheckPoint(), oGameData.levelStage = 2)
            //     } else{
            //         2 == oGameData.levelStage && oGameData.dist >= 1 && !levelOver && raceOver(!0)
            //     }
            // }
            // this.scrollY -= 1.5 * this.speed * delta, 
            // this.scrollY < 0 && (this.scrollY += 500);
            // if(1 == controlMethod) {
            //     if(rightSteer + leftSteer == 1){
            //         this.steerEaseX = Math.min(this.steerEaseX + this.steerRate * delta, this.maxSteer)
            //     }else{
            //         if(rightSteer + leftSteer == -1){
            //             this.steerEaseX = Math.max(this.steerEaseX - this.steerRate * delta, -this.maxSteer)
            //         }else{
            //             if(this.steerEaseX < 0){
            //                 this.steerEaseX = Math.min(this.steerEaseX + this.steerRate * delta, 0)
            //             } else{
            //                 this.steerEaseX = Math.max(this.steerEaseX - this.steerRate * delta, 0)
            //             }
            //         }
            //     }
            // } else{
            //     if(!(0 != controlMethod && 2 != controlMethod)) {
            //         if(0 == manualSteering || levelOver){
            //             if(this.steerEaseX < 0){
            //                 this.steerEaseX = Math.min(this.steerEaseX + this.steerRate * delta, 0)
            //             }else{
            //                 this.steerEaseX = Math.max(this.steerEaseX - this.steerRate * delta, 0)
            //             }
            //         }else{
            //             this.steerEaseX = Math.max(Math.min(this.steerEaseX + manualSteering * this.steerRate * delta, Math.abs(manualSteering) * this.maxSteer), -Math.abs(manualSteering) * this.maxSteer) 
            //         } 
            //     }
            // }
            isAccelerating ? this.speed -= (this.speed - this.maxSpeed) * (this.accRate * delta) : 
            this.speed -= (this.speed - this.minSpeed) * (this.accRate * delta), 
            oGameData.dist += this.speed / this.raceDist / 18e4 * (60 * delta), 
            0 == oGameData.levelStage && oGameData.dist >= 1 / 3 && !levelOver ? (hud.hitCheckPoint(), oGameData.levelStage = 1) : 
                1 == oGameData.levelStage && oGameData.dist >= 2 / 3 && !levelOver ? (hud.hitCheckPoint(), oGameData.levelStage = 2) : 
                2 == oGameData.levelStage && oGameData.dist >= 1 && !levelOver && raceOver(!0), 
            this.scrollY -= 1.5 * this.speed * delta, 
            this.scrollY < 0 && (this.scrollY += 500), 
            1 == controlMethod ? rightSteer + leftSteer == 1 ? this.steerEaseX = Math.min(this.steerEaseX + this.steerRate * delta, this.maxSteer) : 
                    rightSteer + leftSteer == -1 ? this.steerEaseX = Math.max(this.steerEaseX - this.steerRate * delta, -this.maxSteer) : 
                        this.steerEaseX < 0 ? this.steerEaseX = Math.min(this.steerEaseX + this.steerRate * delta, 0) : 
                            this.steerEaseX = Math.max(this.steerEaseX - this.steerRate * delta, 0) : 
                0 != controlMethod && 2 != controlMethod || (0 == manualSteering || levelOver ? this.steerEaseX < 0 ? this.steerEaseX = Math.min(this.steerEaseX + this.steerRate * delta, 0) : 
                this.steerEaseX = Math.max(this.steerEaseX - this.steerRate * delta, 0) : 
                this.steerEaseX = Math.max(Math.min(this.steerEaseX + manualSteering * this.steerRate * delta, Math.abs(manualSteering) * this.maxSteer), -Math.abs(manualSteering) * this.maxSteer)), 
            this.aRowData[this.segNum - 1].x - (canvas.width / 2 + bike.x) < -3900 ? (0 == hud.crashAlpha && hasCrashed(), this.steerEaseX = this.maxSteer) : this.aRowData[this.segNum - 1].x - (canvas.width / 2 + bike.x) > -120 && (0 == hud.crashAlpha && hasCrashed(), this.steerEaseX = -this.maxSteer), 
            ...
            this.scrollInc = this.curve * (.75 * this.speed) * delta, this.scrollX += this.scrollInc, 
            this.scrollX < 0 && (this.scrollX += 525),
            superAccelerating = superAccelerating -1
            if(superAccelerating <= 0){//关闭加速
                road.accRate = road.accRate1;
            }else if(superAccelerating <= 100){//加速时间到进行减速
                isSuperAccelerating = !1;
                road.maxSpeed = road.maxSpeed1;
                panel.switchBut(oImageIds.accOverBtn,oImageIds.accBtn);
            }
            ...
            for (var e = 0; e < this.segNum; e++) {
                this.tempInc = e,
                    ...
                    // console.log("this.segHeightAfter = ",this.segHeightAfter)
                    ...
                    this.aRowData[e].y = this.horizon + this.easeInc * this.roadHeight, this.aRowData[e].scale = 8 * (this.easeInc + this.segHeightAfter) * this.oRoadImgData.oData.spriteWidth + 50,
                0 == t && (this.rowId = e),
                    t += this.segHeightAfter * this.roadHeight,
                t > 1 && (
                    ctx.drawImage(this.oRoadImgData.img, 0, this.rowId * a + this.scrollY, this.oRoadImgData.oData.spriteWidth, a, this.aRowData[this.rowId].x, this.aRowData[this.rowId].y, this.aRowData[this.rowId].scale, t + 1),
                        t = 0);
            }
            ...
            this.skyScale = canvas.width / (this.oSkyImgData.img.width / 2),
                ...
                ctx.drawImage(
                    this.oSkyImgData.img,
                    this.scrollX % 525, 0,
                    this.oSkyImgData.img.width,
                    this.oSkyImgData.img.height,
                    0,
                    canvas.height - road.roadHeight - this.oSkyImgData.img.height * this.skyScale + 131.25 * this.skyScale,
                    this.oSkyImgData.img.width * this.skyScale,
                    this.oSkyImgData.img.height * this.skyScale),
            ...
            for (var i, s, o, r, h, n, e = this.aScenery.length - 1; e >= 0; e--) {
                ...
                this.aScenery[e].scale > .04 && (this.aScenery[e].render(),
                    1 == this.aScenery[e].bollardSideMultiplier 
                    ?(      
                            (s)&&
                            (ctx.beginPath(),
                            // console.log('5878 ==> '),
                    ...
                    :0 == this.aScenery[e].bollardSideMultiplier &&
                        (
                            (h)&&(
                            // console.log('5881 ==> '),
                            ctx.beginPath(),
                    ...
                    1 == this.aScenery[e].bollardSideMultiplier 
                    ?(i = this.aScenery[e].scale, s = this.aScenery[e].bollardX, o = this.aScenery[e].y)
                    :0 == this.aScenery[e].bollardSideMultiplier && (r = this.aScenery[e].scale, h = this.aScenery[e].bollardX, n = this.aScenery[e].y),
...
! function(a) {
    var t = function() {
        function a() {
            switch (this.x = 0, this.y = 0, this.changeLaneInc = 0, this.overtaken = !1, this.typeId = "vehicle", this.hasWhooshed = !1, this.id = Math.floor(5 * Math.random()), this.oVehicleImgData = assetLib.getData("vehicle" + this.id), this.id) {
                case 0:
                    this.offsetY = -13;
                    break;
                case 1:
        ...
        return a.prototype.getNewLane = function() {
            ...
            if((this.rowNum > road.segNum - 150 && this.lane == road.lane  || isSuperAccelerating) && 0 == hud.crashAlpha && !levelOver){
                hud.showWhoosh((1 - (road.segNum - this.rowNum) / 150) / 2 + .5), 
                this.hasWhooshed || lastWhooshLane == this.lane || (playSound("inDraft"), this.hasWhooshed = !0, lastWhooshLane = this.lane)
            }else{
                this.hasWhooshed = !1
            }
            this.rowNum > road.segNum - 5 && !levelOver && (this.x > canvas.width / 2 + bike.x - 300 && this.x < canvas.width / 2 + bike.x + 300 && 0 == hud.crashAlpha ? (hasCrashed(), this.overtaken = !0) : this.x > canvas.width / 2 + bike.x - 600 && this.x < canvas.width / 2 + bike.x + 600 && !this.overtaken && (this.overtaken = !0, hud.addBanner("overtakes")))
...
! function(a) {
    var t = function() {
        ...
        return a.prototype.getBonusTime = function() {
            ...
            } else {!isSuperAccelerating && (isAccelerating = !1);}
            var i = 0;
            ...
            // console.log("road.speed = ",road.speed)
...
var discountData = new Array(0,0,0,0,0,0,0,0,0);
var Utils;
! function(a) {
    var t = function() {
        function a(a) {
        ...
        return a.prototype.clearData = function() {
            ...
            this.aLevelStore.push(0, 0, 0, 0, 0), 
            this.aLevelStore.push(0, 0, 0, 0, 0), 
            this.aLevelStore.push(0, 3, 0), /* 增加三项：分享得车辆、道具、加时 */
            this.aLevelStore.push(0, 0, 0, 0, 0, 0, 0, 0, 0)//增加打折记录
          ...
          return this.aLevelStore[3]
            ...
            var t = !1; //console.log('hasBike:', a);
            return 1 == this.aLevelStore[5 * a + 5] && (t = !0), t
        }, a.prototype.getDiscount = function(a) {
            // var discount = this.aLevelStore[53+a] || 0
            var discount = discountData[a] || 0
            discount > 4 && (discount = 4)
            return discount
        }, a.prototype.setDiscount = function(a,b) {
            // this.aLevelStore[53+a] = b,
            // this.saveData();
            discountData[a] = b;
        }, a.prototype.addDiscount = function(a) {
            // this.aLevelStore[53+a] = this.aLevelStore[53+a] || 0,
            // this.aLevelStore[53+a] += 1,
            // this.aLevelStore[53+a] > 4 && (this.aLevelStore[53+a] = 4),
            // this.saveData();
            discountData[a] = discountData[a] || 0,
            discountData[a] += 1,
            discountData[a] > 4 && (discountData[a] = 4)
          ...
          }, a.prototype.setCoinLeftTime = function() {
            this.aLevelStore[52] = (new Date()).getTime()
          }, a.prototype.getCoinLeftTime = function() {
            return this.aLevelStore[52]
          }, a.prototype.getBikeCount = function() {
            return this.aLevelStore[50]
        }, a.prototype.setBikeCount = function() {
            var o = this.aLevelStore[50]; 
            this.aLevelStore[50] = (new Date()).getTime() // 存储时间戳
            if(o == 0) {
              var t = this.getLatestBike();
              t < 9 && (this.addBike(t + 1), curBike = t + 1);
            }
        }, a.prototype.getAccelCount = function() {
            return this.aLevelStore[51] || 0
        }, a.prototype.setAccelCount = function(a) {
          console.log("===7870==")
            this.aLevelStore[51] += a,this.aLevelStore[51] < 0 && (this.aLevelStore[51] = 0),this.aLevelStore[51] = this.aLevelStore[51] || 0;
          //console.log('读取本地存储数据：', window.famobi.localStorage.getItem(this.saveDataId));
          ...
          //console.log('读取本地存储数据：', window.famobi.localStorage.getItem(this.saveDataId));
            if (null != window.famobi.localStorage.getItem(this.saveDataId) && "" != window.famobi.localStorage.getItem(this.saveDataId)) {
                ...
                this.aLevelStore[50] = this.aLevelStore[50] || 0;
                this.aLevelStore[51] = this.aLevelStore[51] || 3;
                this.aLevelStore[52] = this.aLevelStore[52] || 0;
                for (var a in this.aLevelStore) this.aLevelStore[a] = parseInt(this.aLevelStore[a])
            } else this.saveData()

            //this.aLevelStore[1] = 99999;    //金币最大
          ...
          //console.log('saveData:', this.aLevelStore);
...
var requestAnimFrame = function() {
  ...
  previousTime, canvas = window.canvas,//window.topCanvas.GameCanvas,//window.canvas, window.topCanvas.GameCanvas
    ...
    ios9FirstTouch = !1,
    hasFocus = !0,
    saveDataHandler = new Utils.SaveDataHandler("famobihrev4"),   /* saveDataId */
  famobiPauseActive = !1; 
...
var userInput = new Utils.UserInput(window.canvas, isBugBrowser);
...
var panel, background, totalScore = 0,
    ...
    laneSpeed0, laneSpeed1, laneSpeed2, laneSpeed3, oLaneSpeeds, isAccelerating, isSuperAccelerating, superAccelerating, hud, aBikeData = new Array({
        minSpeed: 120,
        maxSpeed: 135,
        steerRate: 6e3,
        accRate: .5,
    ...
    gameOver = !1,
    getDoubleCoins = !1,
    getDoubleCoinsCount = 0,
    curTime, numberSpace = 29,
    curBike = 0,
    ratio = canvas.width / 1334,    // 图片缩放scale
    upgradeBaseCost = 500,//here
    upgradeInc = 100,
    upgradeBikeInc = 25,
    curBikeShopId = 0,
  ...
  laneTween0, laneTween1, laneTween2, laneTween3, sceneryInc, bikeDiscountList = window.share.getData("bikeDiscountList");

    extGameLoad();
    window.freeSpeedshare = 0
    var share = 0, freeBikeshare = 0 ;
    var bindtapShare = 0;
    var iphoneX = wx.getSystemInfoSync().model.search("iPhone X") != -1;